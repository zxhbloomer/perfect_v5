...
//        + "		   					   and t2.dict_value >= t.type                                                   "
    ...
    String groupListSql = "                                                                                              "
        ...
        + "          FROM                                                                                                "
        + "               m_group t1                                                                                     "
        + "    inner JOIN v_org_relation t2 ON t2.type = '"+ PerfectDictConstant.DICT_ORG_SETTING_TYPE_GROUP +"'         "
        + "           and (t2.code like CONCAT (#{p1.code,jdbcType=VARCHAR},'%') or #{p1.code,jdbcType=VARCHAR} is null) "
        + "           and t1.id = t2.serial_id                                                                           "
        + "     LEFT JOIN m_staff c_staff ON t1.c_id = c_staff.id                                                        "
        + "     LEFT JOIN m_staff u_staff ON t1.u_id = u_staff.id                                                        "
        + "     LEFT JOIN v_org_route_tenant_group_info vor on t1.id = vor.current_id                                    "
        + "         where true                                                                                           "
        + "           and (t1.tenant_id = #{p1.tenant_id,jdbcType=BIGINT} or #{p1.tenant_id,jdbcType=BIGINT} is null)    "
        +"                                                                                                               ";
    /**
    ...
    String companyListSql = "                                                                                           "
        ...
        + "          FROM m_company t1                                                                                  "
        + "    inner JOIN v_org_relation t2 ON t2.type = '"+ PerfectDictConstant.DICT_ORG_SETTING_TYPE_COMPANY +"'       "
        + "           and (t2.code like CONCAT (#{p1.code,jdbcType=VARCHAR},'%') or #{p1.code,jdbcType=VARCHAR} is null) "
        + "           and t1.id = t2.serial_id                                                                           "
        + "     LEFT JOIN m_staff c_staff ON t1.c_id = c_staff.id                                                        "
        + "     LEFT JOIN m_staff u_staff ON t1.u_id = u_staff.id                                                        "
        + "     LEFT JOIN ( SELECT * FROM v_org_route_group_company_info ) vor ON t1.id = vor.current_id                 "
        + "  where true                                                                                                 "
        + "    and (t1.tenant_id = #{p1.tenant_id,jdbcType=BIGINT} or #{p1.tenant_id,jdbcType=BIGINT} is null)          "
        + "                                                                                                             ";
    /**
    ...
    String deptListSql = "                                                                                              "
        ...
        + "      LEFT JOIN m_staff c_staff ON t1.c_id = c_staff.id                                                       "
        + "      LEFT JOIN m_staff u_staff ON t1.u_id = u_staff.id                                                       "
        + "      inner JOIN v_org_relation t6 ON t6.type = '"+ PerfectDictConstant.DICT_ORG_SETTING_TYPE_DEPT +"'        "
        + "           and (t6.code like CONCAT (#{p1.code,jdbcType=VARCHAR},'%') or #{p1.code,jdbcType=VARCHAR} is null) "
        + "           and t1.id = t6.serial_id                                                                           "
        + "      LEFT JOIN ( SELECT * FROM v_org_route_company_dept_info ) vor ON t1.id = vor.current_id                 "
        + "  where true                                                                                                 "
        + "    and (t1.tenant_id = #{p1.tenant_id,jdbcType=BIGINT} or #{p1.tenant_id,jdbcType=BIGINT} is null)          "
        + "                                                                                                             ";
    /**
    ...
    String positionListSql = "                                                                                          "
        ...
        + "   LEFT JOIN m_staff c_staff ON t1.c_id = c_staff.id                                                        "
        + "   LEFT JOIN m_staff u_staff ON t1.u_id = u_staff.id                                                        "
        + "  inner JOIN v_org_relation t6 ON t6.type = '"+ PerfectDictConstant.DICT_ORG_SETTING_TYPE_POSITION +"'      "
        + "         and (t6.code like CONCAT (#{p1.code,jdbcType=VARCHAR},'%') or #{p1.code,jdbcType=VARCHAR} is null) "
        + "         and t1.id = t6.serial_id                                                                           "
        + "   LEFT JOIN ( SELECT * FROM v_org_route_dept_position_info ) vor ON t1.id = vor.current_id                  "
        + "  where true                                                                                                 "
        + "    and (t1.tenant_id = #{p1.tenant_id,jdbcType=BIGINT} or #{p1.tenant_id,jdbcType=BIGINT} is null)          "
        + "                                                                                                             ";
