...
CREATE TABLE `m_address` (
  ...
  `province_code` int DEFAULT NULL COMMENT '省',
  `city_code` int DEFAULT NULL COMMENT '市',
  `area_code` int DEFAULT NULL COMMENT '区',
  `detail_address` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '详细地址',
  `serial_id` bigint DEFAULT NULL COMMENT '关联单号',
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='地址簿';
...
INSERT INTO `m_address` VALUES (2,'123456','刘德华','021-123456',0,'0',31,3101,310117,'上海市 市辖区 松江区西路',NULL,NULL,0,1,25,'2019-11-07 08:38:33',25,'2019-11-07 08:38:33',0),(5,'123456','刘德华','021-123456',0,'0',31,3101,310117,'上海市 市辖区 松江区西路',NULL,NULL,0,1,28,'2020-05-06 15:18:42',28,'2020-05-06 15:18:42',0);
...
CREATE TABLE `m_company` (
  ...
  `address_id` bigint DEFAULT NULL COMMENT '地址簿id',
  ...
  `descr` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '说明',
  `is_del` tinyint(1) DEFAULT NULL COMMENT '是否删除',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `c_id` bigint DEFAULT NULL,
  `c_time` datetime DEFAULT NULL,
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='公司主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_company` VALUES (1,'1','测试企业111','测试企业111',NULL,'1',1.0000,'3','2019-11-05','2019-11-27',0,'121',0,1,25,'2019-11-07 15:54:02',25,'2020-04-17 16:15:10',4),(2,'2','测试企业222','测试企业222',2,'测试企业0',0.0000,'1','2018-11-01','9999-01-01',0,'112',0,1,25,'2019-11-08 11:36:29',28,'2020-05-09 10:23:57',18),(3,'3','测试企业333','测试企业333',NULL,'2',3.0000,'3','2019-11-05','2019-11-27',0,'',0,1,25,'2019-12-02 16:33:08',25,'2020-04-17 09:35:56',3),(4,'123','测试企业00','测试企业00',2,'测试企业00',0.0000,'1','2018-11-01','9999-01-01',0,'1',1,1,25,'2019-12-26 09:44:02',25,'2019-12-26 09:44:02',1),(6,'111','2','3',NULL,'4',5.0000,'3','2020-05-06','2020-05-26',NULL,'8',0,1,28,'2020-05-06 15:41:51',28,'2020-05-06 15:41:51',0),(7,'222','112','1',2,'1',1.0000,'1','2020-05-05','2020-05-20',0,'',0,1,28,'2020-05-07 11:09:10',28,'2020-05-08 11:30:02',5),(8,'12132123','测试企业888','测试企业888',NULL,'2',3.0000,'3','2019-11-05','2019-11-27',0,'aa',0,1,28,'2020-05-14 16:10:54',28,'2020-07-08 11:31:51',1);
...
CREATE TABLE `m_dept` (
  ...
  `handler_id` bigint DEFAULT NULL COMMENT '部门主管',
  `sub_handler_id` bigint DEFAULT NULL COMMENT '部门副主管',
  `leader_id` bigint DEFAULT NULL COMMENT '上级主管领导',
  `response_leader_id` bigint DEFAULT NULL COMMENT '上级分管领导',
  `descr` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '说明',
  `is_del` tinyint(1) DEFAULT NULL COMMENT '是否删除',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `c_id` bigint DEFAULT NULL,
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部门主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_dept` VALUES (1,'xx1','华东事业一部','华东事业一部',NULL,NULL,NULL,NULL,'',0,1,25,'2019-11-25 11:07:20',28,'2020-06-02 10:15:00',12),(2,'DPT20191218AH002','xx','xx',NULL,NULL,NULL,NULL,'',0,1,25,'2019-12-18 14:41:07',25,'2019-12-18 14:41:07',0),(3,'DPT20200508JM001','业务一部','业务一部',25,25,25,NULL,'1',0,1,28,'2020-05-08 16:16:34',28,'2020-06-02 09:53:13',1),(4,'22','上海一部','上海一部',25,26,24,NULL,'',0,1,28,'2020-05-08 16:16:57',28,'2020-06-02 10:15:13',1),(5,'DPT20200508BB002','杨浦分部','杨浦分部',NULL,NULL,NULL,NULL,'',0,1,28,'2020-05-08 16:35:33',28,'2020-06-02 10:15:30',1),(6,'DPT20200601XC001','高管','高管',NULL,NULL,NULL,NULL,'',0,1,28,'2020-06-01 11:14:06',28,'2020-06-01 11:14:06',0);
...
CREATE TABLE `m_group` (
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='集团主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_group` VALUES (4,'1','中建集团1','集团1','111',0,1,25,'2019-10-30 14:14:51',28,'2020-06-22 16:29:19',11),(5,'2','上海集团1','上海集团1','',0,1,25,'2019-10-30 14:17:08',28,'2020-05-14 16:53:25',4),(6,'zjjt01','中建集团111a','中建集团','',0,1,25,'2019-11-18 10:07:45',25,'2019-11-18 10:07:45',3),(7,'zjjt01-01','中建子集团','中建子集团','',0,1,25,'2019-12-02 14:17:19',25,'2019-12-02 14:17:19',2),(8,'zjjt01-02','中建子集团aassssssxx1','中建子集团aa','',0,1,25,'2019-12-02 16:49:24',28,'2020-05-09 10:53:58',14),(9,'GP20191218HK002','xx','xx','',0,1,25,'2019-12-18 14:09:35',25,'2019-12-18 14:09:35',2),(10,'GP20191218SO003','xx1','xx1','22',0,1,25,'2019-12-18 14:10:29',25,'2019-12-18 14:10:29',7),(11,'GP20200102OR001','cx','xxx','1',0,1,25,'2020-01-02 16:44:33',25,'2020-01-02 16:44:33',0),(19,'GP20200102OZ001','x1','x1','11',0,1,25,'2020-01-02 17:03:52',25,'2020-01-02 17:03:52',1),(20,'GP20200102FR001','x2','x2','',0,1,25,'2020-01-02 17:07:24',25,'2020-01-02 17:07:24',0),(21,'GP20200102WL001','x3','x3','',1,1,25,'2020-01-02 17:08:32',25,'2020-01-02 17:08:32',1),(22,'GP20200102DQ001','x4','x4','',1,1,25,'2020-01-02 17:10:09',25,'2020-01-02 17:10:09',9),(23,'GP20200107OW001','x4','x4','',0,1,25,'2020-01-07 14:37:44',25,'2020-01-07 14:37:44',0),(24,'GP20200107BN001','x5','x5','',0,1,25,'2020-01-07 14:37:54',25,'2020-01-07 14:37:54',0),(25,'GP20200107PS001','x6','x6','',0,1,25,'2020-01-07 14:38:02',25,'2020-01-07 14:38:02',0),(26,'GP20200107VO001','x7','x7','',0,1,25,'2020-01-07 15:47:34',25,'2020-01-07 15:47:34',0),(27,'GP20200107AP001','x82','x8','',0,1,25,'2020-01-07 16:01:34',28,'2020-04-17 17:00:56',1),(28,'GP20200107CD002','x9','x9','1',0,1,25,'2020-01-07 16:02:21',28,'2020-04-17 16:24:13',1),(29,'集团编号集团编号集团编号集团编号集团编号','集团编号1','集团编号','集团编号',0,1,28,'2020-05-06 10:20:04',28,'2020-05-07 15:24:30',1),(30,'GP20200514LZ001','3','3','',0,1,28,'2020-05-14 16:09:57',28,'2020-05-14 16:09:57',0),(31,'GP20200514JI002','4','4','',0,1,28,'2020-05-14 16:10:04',28,'2020-05-14 16:10:04',0),(32,'GP20200514QA003','5','5','',0,1,28,'2020-05-14 16:10:11',28,'2020-05-14 16:10:11',0),(33,'GP20200514WD004','6','6','',0,1,28,'2020-05-14 16:10:27',28,'2020-05-14 16:10:27',0),(34,'GP20200514BD005','7','7','',0,1,28,'2020-05-14 16:14:05',28,'2020-05-14 16:14:05',0),(35,'GP20200514HF006','8','8','',0,1,28,'2020-05-14 16:15:26',28,'2020-05-14 16:15:26',0),(36,'GP20200514WZ007','9','9','',0,1,28,'2020-05-14 16:15:47',28,'2020-05-14 16:15:47',0),(37,'GP20200514CR008','中建集团10','集团10','',0,1,28,'2020-05-14 16:16:20',28,'2020-05-25 17:08:00',1),(38,'GP20200514FK009','杨浦区子集团','杨浦区子集团','',0,1,28,'2020-05-14 16:18:53',28,'2020-05-14 16:53:31',2),(39,'GP20200514WH010','控江路集团','控江路集团','',0,1,28,'2020-05-14 16:19:11',28,'2020-05-14 16:52:50',2),(40,'GP20200622IJ001','ax1','ax1','',0,1,28,'2020-06-22 17:09:20',28,'2020-06-22 17:09:20',0),(41,'GP20200622JF002','ax2','ax2','aa',0,1,28,'2020-06-22 17:09:32',28,'2020-07-17 16:29:09',1),(42,'GP20200622JX003','ax3','ax3','',0,1,28,'2020-06-22 17:11:20',28,'2020-07-08 11:31:24',2);
...
CREATE TABLE `m_menu` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `is_default` tinyint(1) DEFAULT '0' COMMENT '默认菜单（0非默认 1默认）',
  ...
  `root_id` bigint DEFAULT NULL COMMENT '根结点id',
  `parent_id` bigint DEFAULT NULL COMMENT '父菜单ID',
  `son_count` int DEFAULT NULL COMMENT '儿子个数',
  `sort` int DEFAULT NULL COMMENT '排序',
  `type` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单类型（R：根结点；N：节点；P：页面）',
  ...
  `page_code` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '页面code',
  `parent_path` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '父结点请求地址',
  `path` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '请求地址',
  `full_path` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '完整地址',
  `route_name` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '路由名，需要唯一，很重要，且需要vue这里手工录入',
  `meta_title` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单名',
  `meta_icon` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单icon',
  `component` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '模块',
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_idx_m_menu_1` (`root_id`,`route_name`),
  KEY `idx_idx_m_menu_2` (`code`,`tenant_id`,`type`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=132 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜单信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_menu` VALUES (89,NULL,'0001','测试',89,NULL,3,0,'R',0,NULL,NULL,NULL,NULL,'/','/',NULL,NULL,NULL,NULL,NULL,'',1,28,'2020-07-20 15:20:49',31,'2020-07-20 17:11:37',4),(90,NULL,'00010001','工作台',89,89,1,0,'T',0,NULL,NULL,NULL,'/','','/','','工作台','工作台','',0,'',1,28,'2020-07-20 15:24:10',31,'2020-07-20 17:11:37',1),(91,NULL,'000100010001','首页',89,90,0,0,'P',0,NULL,15,'P00000070','/','dashboard','/dashboard','P0039','首页','dashboard','@/views/01_dashboard/index',1,'',1,28,'2020-07-20 15:30:41',31,'2020-07-20 17:11:37',1),(92,NULL,'00010002','系统管理',89,89,3,0,'T',0,NULL,NULL,NULL,'/','','/','','系统管理','系统管理','',0,'',1,28,'2020-07-20 15:31:19',31,'2020-07-20 17:11:37',3),(93,NULL,'000100020001','字典管理',89,92,2,0,'N',0,NULL,NULL,NULL,'/','dic','/dic','','','字典管理','',0,'',1,28,'2020-07-20 15:32:15',31,'2020-07-20 17:11:37',2),(94,NULL,'0001000200010001','字典类型',89,93,0,0,'P',0,NULL,2,'P00000030','/dic','dicttype','/dic/dicttype','P0040','系统编码','type','@/views/10_system/dicttype/dicttype',0,'',1,28,'2020-07-20 15:33:05',31,'2020-07-20 17:11:37',0),(95,NULL,'0001000200010002','字典数据',89,93,0,0,'P',0,NULL,3,'P00000050','/dic','dictdata','/dic/dictdata','P0041','字典数据','dict','@/views/10_system/dictdata/dictdata',0,'',1,28,'2020-07-20 15:33:22',31,'2020-07-20 17:11:37',0),(96,NULL,'000100020002','系统设置',89,92,4,0,'N',0,NULL,NULL,NULL,'/','set','/set','','','setting','',0,'',1,28,'2020-07-20 15:34:40',31,'2020-07-20 17:11:37',4),(97,NULL,'0001000200020002','系统编码',89,96,0,0,'P',0,NULL,1,'P00000180','/set','syscode','/set/syscode','P0042','系统编码','syscode','@/views/00_platform/syscode/syscode',0,'',1,28,'2020-07-20 15:35:14',31,'2020-07-20 17:11:37',0),(98,NULL,'0001000200020003','系统参数',89,96,0,0,'P',0,NULL,4,'P00000060','/set','config','/set/config','P0043','系统参数','系统参数','@/views/10_system/config/config',0,'',1,28,'2020-07-20 15:35:37',31,'2020-07-20 17:11:37',0),(99,NULL,'0001000200020004','系统icon',89,96,0,0,'P',0,NULL,16,'P00000230','/set','icons','/set/icons','P0044','系统icon','icons','@/views/10_system/icons/icon',0,'',1,28,'2020-07-20 15:36:06',31,'2020-07-20 17:11:37',0),(100,NULL,'0001000200020001','资源管理',89,96,0,0,'P',0,NULL,17,'P00000020','/set','resource','/set/resource','P0045','资源管理','资源管理','@/views/10_system/resource/resource',0,'',1,28,'2020-07-20 15:37:35',31,'2020-07-20 17:11:37',0),(101,NULL,'00010003','组织机构管理',89,89,2,0,'T',0,NULL,NULL,NULL,'/','','/','','组织机构管理','tree','',0,'',1,28,'2020-07-20 16:35:45',28,'2020-07-20 17:12:14',3),(103,NULL,'000100020003','功能管理',89,92,4,0,'N',0,NULL,NULL,NULL,'/','fun','/fun','','','function','',0,'',1,28,'2020-07-20 16:40:41',31,'2020-07-20 17:11:37',4),(104,NULL,'0001000200030001','按钮维护',89,103,0,0,'P',0,NULL,18,'P00000220','/fun','funs','/fun/funs','P0047','按钮维护','buttons','@/views/10_system/resource/resource',0,'',1,28,'2020-07-20 16:44:01',31,'2020-07-20 17:11:37',0),(105,NULL,'0001000200030002','页面维护',89,103,0,0,'P',0,NULL,19,'P00000200','/fun','pages','/fun/pages','P0048','页面维护','pages','@/views/10_system/pages/page/page',0,'',1,28,'2020-07-20 16:45:37',31,'2020-07-20 17:11:37',0),(106,NULL,'0001000200030003','页面按钮维护',89,103,0,0,'P',0,NULL,20,'P00000210','/fun','page_fun','/fun/page_fun','P0049','页面按钮维护','page_fun','@/views/10_system/pages/page_function/page_function',0,'',1,28,'2020-07-20 16:48:26',31,'2020-07-20 17:11:37',0),(107,NULL,'0001000200030004','菜单维护',89,103,0,0,'P',0,NULL,21,'P00000240','/fun','menus','/fun/menus','P0050','菜单维护','menus','@/views/20_master/menus/menu',0,'',1,28,'2020-07-20 16:51:32',31,'2020-07-20 17:11:37',0),(108,NULL,'000100030001','组织机构维护',89,101,6,0,'N',0,NULL,NULL,NULL,'/','org','/org','','','组织机构管理','',0,'',1,28,'2020-07-20 17:08:42',31,'2020-07-20 17:11:37',6),(109,NULL,'0001000300010001','组织机构管理',89,108,0,0,'P',0,NULL,12,'P00000170','/org','orginfo','/org/orginfo','P0051','组织机构管理','组织架构','@/views/20_master/org/org',0,'',1,28,'2020-07-20 17:09:32',31,'2020-07-20 17:11:37',0),(110,NULL,'0001000300010002','集团信息',89,108,0,0,'P',0,NULL,6,'P00000100','/org','group','/org/group','P0052','集团信息','group','@/views/20_master/group/group',0,'',1,28,'2020-07-20 17:09:57',31,'2020-07-20 17:11:37',0),(111,NULL,'0001000300010003','企业信息',89,108,0,0,'P',0,NULL,7,'P00000110','/org','company','/org/company','P0053','企业信息','company','@/views/20_master/company/company',0,'',1,28,'2020-07-20 17:10:13',31,'2020-07-20 17:11:37',0),(112,NULL,'0001000300010006','员工管理',89,108,0,0,'P',0,NULL,9,'P00000140','/org','staff','/org/staff','P0054','员工管理','staff','@/views/20_master/staff/staff',0,'',1,28,'2020-07-20 17:10:28',31,'2020-07-20 17:11:37',0),(113,NULL,'0001000300010004','部门信息',89,108,0,0,'P',0,NULL,10,'P00000150','/org','dept','/org/dept','P0055','部门信息','dept','@/views/20_master/dept/dept',0,'',1,28,'2020-07-20 17:10:47',31,'2020-07-20 17:11:37',0),(114,NULL,'0001000300010005','岗位信息',89,108,0,0,'P',0,NULL,11,'P00000160','/org','position','/org/position','P0056','岗位信息','position','@/views/20_master/position/position',0,'',1,28,'2020-07-20 17:11:27',31,'2020-07-20 17:11:37',0),(115,NULL,'000100030002','地址簿',89,101,0,0,'P',0,NULL,8,'P00000130','/','address','/address','P0057','地址簿','address','@/views/20_master/address/address',0,'',1,28,'2020-07-20 17:12:14',28,'2020-07-20 17:12:14',0),(130,1,'abc','测试时所所',130,NULL,1,0,'R',0,NULL,NULL,NULL,NULL,'/','/',NULL,NULL,NULL,NULL,NULL,'',1,28,'2020-07-23 09:43:49',28,'2020-08-04 11:17:53',2),(131,1,'abc0001','xx',130,130,0,0,'T',0,NULL,NULL,NULL,'/','','/','','xx','button','',0,'',1,28,'2020-08-04 11:17:53',28,'2020-08-04 11:17:53',0);
...
CREATE TABLE `m_org` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `parent_id` bigint DEFAULT NULL COMMENT '上级组织，null为根节点',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id，根结点',
  `serial_id` bigint DEFAULT NULL COMMENT '关联单号',
  `serial_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关联单号类型',
...
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='组织主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_org` VALUES (1,NULL,1,1,'s_tenant','10','0001',3,29,'2019-11-18 11:27:17',31,'2020-07-14 15:07:02',46),(23,1,1,6,'m_group','20','00010002',1,29,'2019-12-02 14:24:51',31,'2020-07-14 15:07:02',4),(47,94,1,2,'m_company','30','00010001000100010002',1,28,'2020-05-12 15:26:13',31,'2020-07-14 15:07:02',1),(54,47,1,3,'m_dept','40','000100010001000100020001',2,28,'2020-05-14 13:35:19',31,'2020-07-14 15:07:02',4),(55,103,1,10,'m_position','50','0001000100010001000100010001',0,28,'2020-05-14 13:35:28',31,'2020-07-14 15:07:02',0),(56,54,1,9,'m_position','50','0001000100010001000200010001',0,28,'2020-05-14 13:35:33',31,'2020-07-14 15:07:02',0),(57,54,1,8,'m_position','50','0001000100010001000200010002',0,28,'2020-05-14 13:35:36',31,'2020-07-14 15:07:02',0),(92,1,1,5,'m_group','20','00010001',1,28,'2020-05-20 15:37:46',31,'2020-07-14 15:07:02',1),(93,92,1,38,'m_group','20','000100010001',1,28,'2020-05-20 15:38:08',31,'2020-07-14 15:07:02',1),(94,93,1,39,'m_group','20','0001000100010001',2,28,'2020-05-20 15:38:13',31,'2020-07-14 15:07:02',0),(96,23,1,8,'m_company','30','000100020001',1,28,'2020-05-22 10:36:06',31,'2020-07-14 15:07:02',1),(97,96,1,1,'m_dept','40','0001000200010001',1,28,'2020-05-22 10:36:11',31,'2020-07-14 15:07:02',1),(98,97,1,4,'m_dept','40','00010002000100010001',1,28,'2020-05-22 10:36:17',31,'2020-07-14 15:07:02',1),(99,98,1,5,'m_dept','40','000100020001000100010001',1,28,'2020-05-22 11:39:29',31,'2020-07-14 15:07:02',0),(102,94,1,1,'m_company','30','00010001000100010001',1,28,'2020-05-26 13:40:28',31,'2020-07-14 15:07:02',1),(103,102,1,6,'m_dept','40','000100010001000100010001',1,28,'2020-06-01 11:14:08',31,'2020-07-14 15:07:02',1),(104,99,1,5,'m_position','50','0001000200010001000100010001',0,28,'2020-06-01 11:14:16',31,'2020-07-14 15:07:02',0),(105,1,1,29,'m_group','20','00010003',0,28,'2020-06-02 11:52:01',31,'2020-07-14 15:07:02',0);
/*!40000 ALTER TABLE `m_org` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_org_company_dept`
--

DROP TABLE IF EXISTS `m_org_company_dept`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `m_org_company_dept` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `org_id` bigint DEFAULT NULL COMMENT '组织id',
  `org_parent_id` bigint DEFAULT NULL COMMENT '组织parent id',
  `current_id` bigint DEFAULT NULL COMMENT '部门id',
  `parent_id` bigint DEFAULT NULL COMMENT '所属部门id',
  `parent_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所属父结点类型',
  `root_id` bigint DEFAULT NULL COMMENT '根部门id',
  `root_company_id` bigint DEFAULT NULL COMMENT '根集团id',
  `counts` int DEFAULT NULL COMMENT '当前集团对应上级所有集团数量',
  `sort` int DEFAULT NULL COMMENT '当前集团对应上级所有集团数量排序',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `c_id` bigint DEFAULT NULL,
  `c_time` datetime DEFAULT NULL,
  `u_id` bigint DEFAULT NULL,
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_m_org_dept_dept_1` (`current_id`) /*!80000 INVISIBLE */,
  KEY `idx_m_org_dept_dept_2` (`tenant_id`),
  KEY `idx_m_org_dept_dept_3` (`org_id`,`org_parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=426 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='部门与部门关系表，多部门嵌套关系表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `m_org_company_dept`
--

LOCK TABLES `m_org_company_dept` WRITE;
/*!40000 ALTER TABLE `m_org_company_dept` DISABLE KEYS */;
INSERT INTO `m_org_company_dept` VALUES (421,103,102,6,1,'m_company',6,1,1,1,1,28,'2020-07-14 15:07:02',28,'2020-07-14 15:07:02',0),(422,54,47,3,2,'m_company',3,2,1,1,1,28,'2020-07-14 15:07:02',28,'2020-07-14 15:07:02',0),(423,97,96,1,8,'m_company',1,8,3,1,1,28,'2020-07-14 15:07:03',28,'2020-07-14 15:07:03',0),(424,98,97,4,1,'m_dept',1,8,3,2,1,28,'2020-07-14 15:07:03',28,'2020-07-14 15:07:03',0),(425,99,98,5,4,'m_dept',1,8,3,3,1,28,'2020-07-14 15:07:03',28,'2020-07-14 15:07:03',0);
/*!40000 ALTER TABLE `m_org_company_dept` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_org_dept_position`
--

DROP TABLE IF EXISTS `m_org_dept_position`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `m_org_dept_position` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `org_id` bigint DEFAULT NULL COMMENT '组织id',
  `org_parent_id` bigint DEFAULT NULL COMMENT '组织parent id',
  `current_id` bigint DEFAULT NULL COMMENT '岗位id',
  `parent_id` bigint DEFAULT NULL COMMENT '所属部门id',
  `parent_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所属父结点类型',
  `root_id` bigint DEFAULT NULL COMMENT '根部门id',
  `counts` int DEFAULT NULL COMMENT '嵌套时会>1',
  `sort` int DEFAULT NULL COMMENT '嵌套时的排序',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `c_id` bigint DEFAULT NULL,
  `c_time` datetime DEFAULT NULL,
  `u_id` bigint DEFAULT NULL,
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_m_org_position_dept_1` (`current_id`),
  KEY `idx_m_org_position_dept_2` (`tenant_id`),
  KEY `idx_m_org_position_dept_3` (`org_id`,`org_parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=412 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='岗位与部门关系表，部门->岗位';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `m_org_dept_position`
--

LOCK TABLES `m_org_dept_position` WRITE;
/*!40000 ALTER TABLE `m_org_dept_position` DISABLE KEYS */;
INSERT INTO `m_org_dept_position` VALUES (408,55,103,10,6,'m_dept',10,1,1,1,28,'2020-07-14 15:07:02',28,'2020-07-14 15:07:02',0),(409,56,54,9,3,'m_dept',9,1,1,1,28,'2020-07-14 15:07:03',28,'2020-07-14 15:07:03',0),(410,57,54,8,3,'m_dept',8,1,1,1,28,'2020-07-14 15:07:03',28,'2020-07-14 15:07:03',0),(411,104,99,5,5,'m_dept',5,1,1,1,28,'2020-07-14 15:07:03',28,'2020-07-14 15:07:03',0);
/*!40000 ALTER TABLE `m_org_dept_position` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_org_group_company`
--

DROP TABLE IF EXISTS `m_org_group_company`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `m_org_group_company` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `org_id` bigint DEFAULT NULL COMMENT '组织id',
  `org_parent_id` bigint DEFAULT NULL COMMENT '组织parent id',
  `current_id` bigint DEFAULT NULL COMMENT '企业id',
  `parent_id` bigint DEFAULT NULL COMMENT '所属集团id',
  `parent_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所属父结点类型',
  `root_id` bigint DEFAULT NULL COMMENT '根企业id',
  `root_group_id` bigint DEFAULT NULL COMMENT '根集团id',
  `counts` int DEFAULT NULL COMMENT '嵌套时会>1',
  `sort` int DEFAULT NULL COMMENT '嵌套时的排序',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `c_id` bigint DEFAULT NULL,
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_m_org_company_group_1` (`current_id`),
  KEY `idx_m_org_company_group_2` (`tenant_id`),
  KEY `idx_m_org_company_group_3` (`org_id`,`org_parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=348 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='集团与企业关系表，集团->企业关系';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `m_org_group_company`
--

LOCK TABLES `m_org_group_company` WRITE;
/*!40000 ALTER TABLE `m_org_group_company` DISABLE KEYS */;
INSERT INTO `m_org_group_company` VALUES (345,102,94,1,39,'m_group',1,39,1,1,1,28,'2020-07-14 15:07:02',28,'2020-07-14 15:07:02',0),(346,47,94,2,39,'m_group',2,39,1,1,1,28,'2020-07-14 15:07:02',28,'2020-07-14 15:07:02',0),(347,96,23,8,6,'m_group',8,6,1,1,1,28,'2020-07-14 15:07:03',28,'2020-07-14 15:07:03',0);
/*!40000 ALTER TABLE `m_org_group_company` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_org_tenant_group`
--

DROP TABLE IF EXISTS `m_org_tenant_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `m_org_tenant_group` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `org_id` bigint DEFAULT NULL COMMENT '组织id',
  `org_parent_id` bigint DEFAULT NULL COMMENT '组织parent id',
  `current_id` bigint DEFAULT NULL COMMENT '集团id',
  `parent_id` bigint DEFAULT NULL COMMENT '所属集团id',
  `parent_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所属父结点类型',
  `root_id` bigint DEFAULT NULL COMMENT '根集团id',
  `counts` int DEFAULT NULL COMMENT '嵌套时会>1',
  `sort` int DEFAULT NULL COMMENT '从根集团到当前集团的排序',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `c_id` bigint DEFAULT NULL,
  `c_time` datetime DEFAULT NULL,
  `u_id` bigint DEFAULT NULL,
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_m_org_group_group_1` (`current_id`) /*!80000 INVISIBLE */,
  KEY `idx_m_org_group_group_2` (`tenant_id`),
  KEY `idx_m_org_group_group_3` (`org_id`,`org_parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=556 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='集团与集团关系表，多集团嵌套关系表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `m_org_tenant_group`
--

LOCK TABLES `m_org_tenant_group` WRITE;
/*!40000 ALTER TABLE `m_org_tenant_group` DISABLE KEYS */;
INSERT INTO `m_org_tenant_group` VALUES (551,92,1,5,1,'s_tenant',5,3,1,1,28,'2020-07-14 15:07:02',28,'2020-07-14 15:07:02',0),(552,93,92,38,5,'m_group',5,3,2,1,28,'2020-07-14 15:07:02',28,'2020-07-14 15:07:02',0),(553,94,93,39,38,'m_group',5,3,3,1,28,'2020-07-14 15:07:02',28,'2020-07-14 15:07:02',0),(554,23,1,6,1,'s_tenant',6,1,1,1,28,'2020-07-14 15:07:03',28,'2020-07-14 15:07:03',0),(555,105,1,29,1,'s_tenant',29,1,1,1,28,'2020-07-14 15:07:03',28,'2020-07-14 15:07:03',0);
/*!40000 ALTER TABLE `m_org_tenant_group` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `m_permission` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `type` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型：10（部门权限）、20（岗位权限）、30（用户权限）、40（排除权限）',
  `serial_type` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关联单号类型',
  `serial_id` bigint DEFAULT NULL COMMENT '关联单号',
  `name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单名称',
  `menu_id` bigint DEFAULT NULL COMMENT '关联单号',
  `status` tinyint(1) DEFAULT NULL COMMENT '0:未使用，1:已使用',
  `descr` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '说明',
  `is_del` tinyint(1) DEFAULT NULL COMMENT '是否是已经删除(1:true-已删除,0:false-未删除)',
  `is_enable` tinyint(1) DEFAULT NULL COMMENT '是否启用(1:true-已启用,0:false-已禁用)',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `c_id` bigint DEFAULT NULL,
  `c_time` datetime DEFAULT NULL,
  `u_id` bigint DEFAULT NULL,
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_permission` VALUES (7,'10','m_dept',6,'1',NULL,NULL,'1',1,0,1,28,'2020-07-31 14:06:37',28,'2020-07-31 16:01:08',13),(8,'10','m_dept',6,'1',NULL,0,'12',0,0,1,28,'2020-07-31 16:17:18',28,'2020-07-31 16:28:15',1),(9,'10','m_dept',6,'1',NULL,NULL,'1',0,0,1,28,'2020-07-31 16:28:21',28,'2020-07-31 16:28:21',0),(10,'10','m_dept',6,'1',NULL,0,'112',0,0,1,28,'2020-07-31 16:28:48',28,'2020-07-31 16:28:48',0),(11,'10','m_dept',6,'5',NULL,0,'5',0,0,1,28,'2020-07-31 16:29:02',28,'2020-07-31 16:29:02',0),(12,'10','m_dept',6,'6',89,0,'6',0,0,1,28,'2020-07-31 16:29:19',28,'2020-08-12 17:24:07',2);
/*!40000 ALTER TABLE `m_permission` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_permission_menu`
--
...
CREATE TABLE `m_permission_menu` (
  ...
  `menu_id` bigint DEFAULT NULL COMMENT 'menu_id，数据通过复制m_menu，为不破坏表连接关系，该字段记录m_menu.id',
  `is_default` tinyint(1) DEFAULT '0' COMMENT '默认菜单（0非默认 1默认）',
  `code` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '编码',
  `name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单名称',
  `root_id` bigint DEFAULT NULL COMMENT '根结点id',
  ...
  `son_count` int DEFAULT NULL COMMENT '儿子个数',
  `sort` int DEFAULT NULL COMMENT '排序',
  `type` varchar(2) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单类型（R：根节点；N：结点；P：页面）',
  `visible` tinyint(1) DEFAULT NULL COMMENT '菜单状态（0显示 1隐藏）',
  `perms` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '权限标识',
  `page_id` bigint DEFAULT NULL COMMENT '页面id',
  `page_code` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '页面code',
  `parent_path` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '父结点请求地址',
  `path` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '请求地址',
  `full_path` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '完整地址',
  `route_name` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '路由名，需要唯一，很重要，且需要vue这里手工录入',
  `meta_title` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单名',
  `meta_icon` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单icon',
  `component` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '模块',
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_m_permission_menu_2` (`code`,`tenant_id`,`type`),
  KEY `idx_m_permission_menu_1` (`root_id`,`route_name`),
  KEY `idx_m_permission_menu_3` (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=375 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='权限菜单信息';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `m_permission_menu`
--

LOCK TABLES `m_permission_menu` WRITE;
/*!40000 ALTER TABLE `m_permission_menu` DISABLE KEYS */;
INSERT INTO `m_permission_menu` VALUES (349,12,89,NULL,'0001','测试',89,NULL,3,0,'R',0,NULL,NULL,NULL,NULL,'/','/',NULL,NULL,NULL,NULL,NULL,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(350,12,90,NULL,'00010001','工作台',89,89,1,0,'T',0,NULL,NULL,NULL,'/','','/','','工作台','工作台','',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(351,12,91,NULL,'000100010001','首页',89,90,0,0,'P',0,NULL,15,'P00000070','/','dashboard','/dashboard','P0039','首页','dashboard','@/views/01_dashboard/index',1,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(352,12,92,NULL,'00010002','系统管理',89,89,3,0,'T',0,NULL,NULL,NULL,'/','','/','','系统管理','系统管理','',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(353,12,93,NULL,'000100020001','字典管理',89,92,2,0,'N',0,NULL,NULL,NULL,'/','dic','/dic','','','字典管理','',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(354,12,94,NULL,'0001000200010001','字典类型',89,93,0,0,'P',0,NULL,2,'P00000030','/dic','dicttype','/dic/dicttype','P0040','系统编码','type','@/views/10_system/dicttype/dicttype',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(355,12,95,NULL,'0001000200010002','字典数据',89,93,0,0,'P',0,NULL,3,'P00000050','/dic','dictdata','/dic/dictdata','P0041','字典数据','dict','@/views/10_system/dictdata/dictdata',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(356,12,96,NULL,'000100020002','系统设置',89,92,4,0,'N',0,NULL,NULL,NULL,'/','set','/set','','','setting','',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(357,12,97,NULL,'0001000200020002','系统编码',89,96,0,0,'P',0,NULL,1,'P00000180','/set','syscode','/set/syscode','P0042','系统编码','syscode','@/views/00_platform/syscode/syscode',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(358,12,98,NULL,'0001000200020003','系统参数',89,96,0,0,'P',0,NULL,4,'P00000060','/set','config','/set/config','P0043','系统参数','系统参数','@/views/10_system/config/config',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(359,12,99,NULL,'0001000200020004','系统icon',89,96,0,0,'P',0,NULL,16,'P00000230','/set','icons','/set/icons','P0044','系统icon','icons','@/views/10_system/icons/icon',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(360,12,100,NULL,'0001000200020001','资源管理',89,96,0,0,'P',0,NULL,17,'P00000020','/set','resource','/set/resource','P0045','资源管理','资源管理','@/views/10_system/resource/resource',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(361,12,101,NULL,'00010003','组织机构管理',89,89,2,0,'T',0,NULL,NULL,NULL,'/','','/','','组织机构管理','tree','',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(362,12,103,NULL,'000100020003','功能管理',89,92,4,0,'N',0,NULL,NULL,NULL,'/','fun','/fun','','','function','',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(363,12,104,NULL,'0001000200030001','按钮维护',89,103,0,0,'P',0,NULL,18,'P00000220','/fun','funs','/fun/funs','P0047','按钮维护','buttons','@/views/10_system/resource/resource',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(364,12,105,NULL,'0001000200030002','页面维护',89,103,0,0,'P',0,NULL,19,'P00000200','/fun','pages','/fun/pages','P0048','页面维护','pages','@/views/10_system/pages/page/page',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(365,12,106,NULL,'0001000200030003','页面按钮维护',89,103,0,0,'P',0,NULL,20,'P00000210','/fun','page_fun','/fun/page_fun','P0049','页面按钮维护','page_fun','@/views/10_system/pages/page_function/page_function',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(366,12,107,NULL,'0001000200030004','菜单维护',89,103,0,0,'P',0,NULL,21,'P00000240','/fun','menus','/fun/menus','P0050','菜单维护','menus','@/views/20_master/menus/menu',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(367,12,108,NULL,'000100030001','组织机构维护',89,101,6,0,'N',0,NULL,NULL,NULL,'/','org','/org','','','组织机构管理','',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(368,12,109,NULL,'0001000300010001','组织机构管理',89,108,0,0,'P',0,NULL,12,'P00000170','/org','orginfo','/org/orginfo','P0051','组织机构管理','组织架构','@/views/20_master/org/org',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(369,12,110,NULL,'0001000300010002','集团信息',89,108,0,0,'P',0,NULL,6,'P00000100','/org','group','/org/group','P0052','集团信息','group','@/views/20_master/group/group',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(370,12,111,NULL,'0001000300010003','企业信息',89,108,0,0,'P',0,NULL,7,'P00000110','/org','company','/org/company','P0053','企业信息','company','@/views/20_master/company/company',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(371,12,112,NULL,'0001000300010006','员工管理',89,108,0,0,'P',0,NULL,9,'P00000140','/org','staff','/org/staff','P0054','员工管理','staff','@/views/20_master/staff/staff',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(372,12,113,NULL,'0001000300010004','部门信息',89,108,0,0,'P',0,NULL,10,'P00000150','/org','dept','/org/dept','P0055','部门信息','dept','@/views/20_master/dept/dept',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(373,12,114,NULL,'0001000300010005','岗位信息',89,108,0,0,'P',0,NULL,11,'P00000160','/org','position','/org/position','P0056','岗位信息','position','@/views/20_master/position/position',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(374,12,115,NULL,'000100030002','地址簿',89,101,0,0,'P',0,NULL,8,'P00000130','/','address','/address','P0057','地址簿','address','@/views/20_master/address/address',0,'',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0);
/*!40000 ALTER TABLE `m_permission_menu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_permission_operation`
--

DROP TABLE IF EXISTS `m_permission_operation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `m_permission_operation` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `operation_id` bigint DEFAULT NULL COMMENT 'operation_id，数据通过复制s_pages_function，为不破坏表连接关系，该字段记录s_pages_function.id',
  `page_id` bigint DEFAULT NULL COMMENT '页面id',
  `is_enable` tinyint(1) DEFAULT NULL COMMENT '是否启用(0:false-已禁用,1:true-已启用)',
  `type` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型：PAGE：主页面上，TABLE：表格上，POPUP：弹出框上',
  `function_id` bigint DEFAULT NULL COMMENT '按钮id',
  `sort` int DEFAULT NULL COMMENT '排序',
  `perms` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '权限标识',
  `descr` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '说明',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_m_permission_operation_1` (`page_id`,`type`,`function_id`,`sort`,`operation_id`)
) ENGINE=InnoDB AUTO_INCREMENT=204 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='权限页面操作表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `m_permission_operation`
--

LOCK TABLES `m_permission_operation` WRITE;
/*!40000 ALTER TABLE `m_permission_operation` DISABLE KEYS */;
INSERT INTO `m_permission_operation` VALUES (180,4,6,1,NULL,1,1,'P_GROUP:ADD',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(181,9,6,0,NULL,2,2,'P_GROUP:UPDATE',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(182,10,6,0,'',3,3,'P_GROUP:COPY_INSERT',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(183,13,6,1,'',11,4,'P_GROUP:EXPORT',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(184,14,6,0,'',5,5,'P_GROUP:INFO','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(185,15,6,0,'',6,6,'P_GROUP:T_DELETE','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(186,16,6,0,'',12,7,'P_GROUP:D_OK','弹出框中的确定',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(187,17,7,0,NULL,1,1,'P_COMPANY:ADD',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(188,18,7,1,NULL,2,2,'P_COMPANY:UPDATE',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(189,19,7,1,'',3,3,'P_COMPANY:COPY_INSERT','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(190,20,7,1,'',11,4,'P_COMPANY:EXPORT','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(191,21,7,1,'',5,5,'P_COMPANY:INFO','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(192,22,7,1,'',6,6,'P_COMPANY:T_DELETE','表格内删除',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(193,23,7,1,'',12,7,'P_COMPANY:D_OK','弹出框中的确定',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(194,24,8,1,NULL,1,1,'P_ADDRESS:ADD',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(195,25,8,1,NULL,2,2,'P_ADDRESS:UPDATE',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(196,26,8,1,'',3,3,'P_ADDRESS:COPY_INSERT','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(197,27,8,1,'',27,4,'P_ADDRESS:DELETE','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(198,28,8,1,'',5,5,'P_ADDRESS:INFO','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(199,29,8,0,'',12,6,'P_ADDRESS:D_OK','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(200,30,9,0,NULL,1,1,'P_STAFF:ADD',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(201,31,9,0,'',2,2,'P_STAFF:UPDATE','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(202,32,9,0,'',11,3,'P_STAFF:EXPORT','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(203,33,9,0,'',5,4,'P_STAFF:INFO','',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0);
/*!40000 ALTER TABLE `m_permission_operation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_permission_pages`
--

DROP TABLE IF EXISTS `m_permission_pages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `m_permission_pages` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `page_id` bigint DEFAULT NULL COMMENT 'page_id，数据通过复制s_pages，为不破坏表连接关系，该字段记录s_pages.id',
  ...
  `name` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '页面名称',
  ...
  `u_id` bigint DEFAULT NULL,
  `u_time` datetime DEFAULT NULL,
  `dbversion` int DEFAULT NULL COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_m_permission_pages_1` (`code`,`component`,`perms`),
  KEY `idx_m_permission_pages_2` (`page_id`)
) ENGINE=InnoDB AUTO_INCREMENT=192 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='权限页面表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `m_permission_pages`
--

LOCK TABLES `m_permission_pages` WRITE;
/*!40000 ALTER TABLE `m_permission_pages` DISABLE KEYS */;
INSERT INTO `m_permission_pages` VALUES (174,1,'P00000180','系统编码','@/views/00_platform/syscode/syscode','P_SYSCODE','系统编码','syscode','11',1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(175,2,'P00000030','字典类型','@/views/10_system/dicttype/dicttype','P_DICT_TYPE','系统编码','type',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(176,3,'P00000050','字典数据','@/views/10_system/dictdata/dictdata','P_DICT_DATA','字典数据','dict',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(177,4,'P00000060','系统参数','@/views/10_system/config/config','P_CONFIG','系统参数','系统参数',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(178,6,'P00000100','集团信息','@/views/20_master/group/group','P_GROUP','集团信息','group',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(179,7,'P00000110','企业信息','@/views/20_master/company/company','P_COMPANY','企业信息','company',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(180,8,'P00000130','地址簿','@/views/20_master/address/address','P_ADDRESS','地址簿','address',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(181,9,'P00000140','员工管理','@/views/20_master/staff/staff','P_STAFF','员工管理','staff',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(182,10,'P00000150','部门信息','@/views/20_master/dept/dept','P_DEPT','部门信息','dept',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(183,11,'P00000160','岗位信息','@/views/20_master/position/position','P_POSITION','岗位信息','position',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(184,12,'P00000170','组织机构管理','@/views/20_master/org/org','P_ORG','组织机构管理','组织机构管理',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(185,15,'P00000070','首页','@/views/01_dashboard/index','P_DASHBOARD','首页','dashboard',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(186,16,'P00000230','系统icon','@/views/10_system/icons/icon','P_ICONS','系统icon','icons',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(187,17,'P00000020','资源管理','@/views/10_system/resource/resource','P_RESOURCE','资源管理','资源管理',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(188,18,'P00000220','按钮维护','@/views/10_system/pages/function/function','P_SYS_FUNCTIONS','按钮维护','buttons',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(189,19,'P00000200','页面维护','@/views/10_system/pages/page/page','P_SYS_FUNCTIONS','页面维护','pages',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(190,20,'P00000210','页面按钮维护','@/views/10_system/pages/page_function/page_function','P_SYS_PAGE_FUNCTIONS','页面按钮维护','page_fun',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0),(191,21,'P00000240','菜单维护','@/views/20_master/menus/menu','P_MENUS','菜单维护','menus',NULL,1,28,'2020-08-12 17:24:01',28,'2020-08-12 17:24:01',0);
/*!40000 ALTER TABLE `m_permission_pages` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `m_position` (
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='岗位主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_position` VALUES (4,'DEPT20191218IS001','x11啊1122','x1','111',0,1,25,'2019-12-18 14:56:57',28,'2020-05-12 09:16:59',29),(5,'DEPT20191219VG002','监事','监事','22',0,1,25,'2019-12-19 08:55:41',28,'2020-04-21 15:07:39',1),(6,'DEPT20200429AM001','2','2','2',0,1,28,'2020-04-29 15:36:30',28,'2020-04-29 15:36:30',0),(7,'1','1','1','1',0,1,28,'2020-04-29 15:42:27',28,'2020-04-29 15:42:27',0),(8,'3','文职岗','文职岗','3',0,1,28,'2020-04-29 15:43:02',28,'2020-06-02 09:54:15',1),(9,'4','4','4','',0,1,28,'2020-04-29 15:43:23',28,'2020-04-29 15:43:23',0),(10,'5','业务岗','业务岗','',0,1,28,'2020-04-29 15:43:37',28,'2020-06-02 09:53:35',1),(11,'6','6','6','6',1,1,28,'2020-04-29 15:45:20',28,'2020-04-29 16:15:09',1);
...
CREATE TABLE `m_staff` (
  ...
  `sex` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '男=1,女=2',
  ...
  `user_id` bigint DEFAULT NULL COMMENT '登陆用户id，关联id',
  `company_id` bigint DEFAULT NULL COMMENT '所属公司',
  `dept_id` bigint DEFAULT NULL COMMENT '默认部门',
  `descr` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '说明',
  `is_del` tinyint(1) DEFAULT NULL COMMENT '是否删除',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `c_id` bigint DEFAULT NULL,
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `idx_m_staff_1` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户组织机构关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_staff` VALUES (22,'负责人',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,0,1,25,'2019-11-12 11:19:48',25,'2019-11-12 11:19:48',1),(23,'副负责人',NULL,NULL,NULL,'',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,2,NULL,NULL,0,1,25,'2019-11-12 11:21:20',25,'2020-04-20 10:53:22',2),(24,'领导',NULL,NULL,NULL,'',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,33,2,NULL,NULL,0,1,25,'2019-11-12 11:22:34',25,'2020-03-16 13:23:08',5),(25,'刘德华','','','','1',NULL,'5',0,'1','2','3','4','6','','','','','啊','',24,2,3,'2221',0,1,25,'2019-11-12 11:22:34',28,'2020-06-04 16:21:06',42),(26,'领导1想',NULL,NULL,NULL,'1',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,34,NULL,NULL,NULL,0,1,25,'2019-11-12 11:22:34',25,'2020-04-20 10:54:56',5),(28,'测试用户','','测试用户','','',NULL,'',0,'','','','','','','','','','','',31,NULL,NULL,'',0,1,25,'2019-12-16 14:25:08',28,'2020-06-05 14:56:50',3),(29,'',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,44,NULL,NULL,'1',0,1,28,'2020-06-01 16:21:27',28,'2020-06-01 16:21:27',1);
...
CREATE TABLE `m_staff_org` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `staff_id` bigint DEFAULT NULL COMMENT '员工主表id',
  `serial_id` bigint DEFAULT NULL COMMENT '关联单号',
  `serial_type` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关联单号类型',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `c_id` bigint DEFAULT NULL,
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_m_staff_org_1` (`serial_id`,`serial_type`),
  KEY `idx_m_staff_org_2` (`staff_id`)
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户组织机构关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_staff_org` VALUES (95,26,4,'m_position',1,29,'2020-03-25 16:56:05',29,'2020-03-25 16:56:05',0),(96,22,4,'m_position',1,29,'2020-03-25 17:02:31',29,'2020-03-25 17:02:31',0),(99,22,5,'m_position',1,28,'2020-04-27 10:28:10',28,'2020-04-27 10:28:10',0),(101,25,5,'m_position',1,28,'2020-04-28 11:04:52',28,'2020-04-28 11:04:52',0),(104,26,5,'m_position',1,28,'2020-05-12 16:36:19',28,'2020-05-12 16:36:19',0),(106,28,5,'m_position',1,28,'2020-05-12 16:46:37',28,'2020-05-12 16:46:37',0),(108,25,6,'m_position',1,28,'2020-05-28 14:32:43',28,'2020-05-28 14:32:43',0),(109,25,8,'m_position',1,28,'2020-05-28 15:51:39',28,'2020-05-28 15:51:39',0),(110,25,9,'m_position',1,28,'2020-05-28 15:52:09',28,'2020-05-28 15:52:09',0),(111,25,7,'m_position',1,28,'2020-05-28 15:53:09',28,'2020-05-28 15:53:09',0),(122,24,10,'m_position',1,28,'2020-06-01 15:51:51',28,'2020-06-01 15:51:51',0),(123,26,10,'m_position',1,28,'2020-06-01 15:51:51',28,'2020-06-01 15:51:51',0),(128,25,2,'m_company',1,28,'2020-06-04 16:21:06',28,'2020-06-04 16:21:06',0),(129,25,3,'m_dept',1,28,'2020-06-04 16:21:06',28,'2020-06-04 16:21:06',0);
...
CREATE TABLE `m_user` (
  ...
  `err_count` int DEFAULT NULL COMMENT '登录错误次数\n',
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `idx_m_user_1` (`login_name`) USING BTREE,
  UNIQUE KEY `idx_m_user_2` (`staff_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_user` VALUES (1,NULL,'zxh1',NULL,NULL,'$2a$10$x66JhJCybrBiq..3Q1mfcerbPCI1064U0H20ziP0mHrwqIj15hX7e',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,0),(24,'20','xx@xx.com',NULL,NULL,'$2a$10$kwXKnfYeNUq9cHsxUK66VOehmytV.7s3tVjJ6lTwUIq5KghQg0pSK',0,0,1,NULL,NULL,NULL,NULL,25,NULL,0,0,NULL,'123456',NULL,NULL,1,1,'2019-11-12 11:19:48',28,'2020-06-04 16:21:06',13),(25,NULL,NULL,NULL,NULL,'',0,0,0,NULL,NULL,NULL,NULL,23,NULL,0,0,NULL,NULL,NULL,NULL,1,1,'2019-11-12 11:21:20',28,'2020-04-20 10:53:22',2),(26,NULL,NULL,NULL,NULL,'',0,0,0,NULL,NULL,NULL,NULL,26,NULL,0,0,'0',NULL,NULL,NULL,1,1,'2019-11-12 11:22:34',29,'2020-03-10 15:39:16',4),(29,NULL,'zxh',NULL,NULL,'$2a$10$Jzk3mcGW.K36f65cnn9oWOfJhBiJFnmb.k5IkQGkwE4YGf2p60OYK',0,0,1,NULL,NULL,NULL,NULL,10,NULL,0,0,'0',NULL,NULL,NULL,1,1,'2019-11-14 16:55:00',28,'2020-04-20 10:55:15',10),(31,'10','13611806866','60',NULL,'$2a$10$CDJsGidr3OcQdCz/SDkkee/vdXBwEeRW.WSWsXom28A1ws5X9tgVG',0,0,1,NULL,NULL,NULL,NULL,28,NULL,1,0,'0','$2a$10$gaatWx6cHePBO3Gxrxt2PuRl9G5f6px09Fe9F8Ce773VL2rLH8ldW',NULL,NULL,1,NULL,'2019-12-16 14:25:08',28,'2020-06-05 14:56:50',2),(44,'',NULL,NULL,NULL,'',0,0,0,NULL,NULL,NULL,NULL,29,NULL,0,0,NULL,NULL,NULL,NULL,1,28,'2020-06-01 16:21:27',28,'2020-06-01 16:21:27',1);
...
CREATE TABLE `s_area_provinces` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `code` int DEFAULT NULL COMMENT '省份编号',
...
CREATE TABLE `s_code` (
  ...
  `auto_create` int DEFAULT NULL COMMENT '代码增加序号',
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='编码控制';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_code` VALUES (2,'s_tenant','10','ZH20191216NX001',1,'ZH',25,'2019-12-13 15:11:44',25,'2019-12-13 15:33:12',5),(4,'s_menu','10','M20191216KZ007',7,'M',25,'2019-12-16 15:48:54',25,'2019-12-16 15:48:54',6),(5,'m_group','10','GP20200622JX003',3,'GP',25,'2019-12-18 14:03:36',28,'2020-06-22 17:11:20',26),(6,'m_dept','10','DPT20200601XC001',1,'DPT',25,'2019-12-18 14:36:48',28,'2020-06-01 11:14:06',4),(8,'m_position','10','DEPT20200429AM001',1,'DEPT',25,'2019-12-18 14:54:04',28,'2020-04-29 15:36:30',4),(12,'m_menu','11','P0057',57,'PC',28,'2020-07-08 10:12:36',28,'2020-07-20 17:12:14',57);
/*!40000 ALTER TABLE `s_code` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `s_column_size`
--

DROP TABLE IF EXISTS `s_column_size`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `s_column_size` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `page_code` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '配置vue export default  name时所使用的type：constants_program.P_VUE_SETTING',
  `page_id` bigint DEFAULT NULL COMMENT '页面id',
  `type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型：基本上页面只有一个table，如果出现两个table则需要区分',
  `staff_id` bigint DEFAULT NULL COMMENT '员工id',
  `column_property` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'table的column的property属性',
  `column_label` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'table的column的label属性',
  `column_index` int DEFAULT NULL COMMENT 'table的column的第几个列，从0开始',
  `min_width` int DEFAULT NULL COMMENT '列宽',
  `real_width` int DEFAULT NULL COMMENT '列宽',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_s_column_size_1` (`page_code`,`type`,`staff_id`,`column_index`) /*!80000 INVISIBLE */
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='表格列宽';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `s_column_size`
--

LOCK TABLES `s_column_size` WRITE;
/*!40000 ALTER TABLE `s_column_size` DISABLE KEYS */;
INSERT INTO `s_column_size` VALUES (1,'D00000100',NULL,NULL,28,'name','集团名称',1,150,191),(2,'P00000100',NULL,NULL,28,'parent_group_simple_name','上级集团',2,130,240),(3,'P00000100',NULL,NULL,28,'u_time','更新时间',8,180,347),(4,'P00000100',NULL,NULL,28,'name','集团名称',3,150,286),(6,'P00000170',NULL,'org_table',28,'name','组织机构名称',1,250,283),(8,'P00000174',NULL,'org_group',28,'parent_group_simple_name','上级集团',1,230,194),(10,'D00000100',NULL,'pop_group',28,'name','集团名称',1,150,260),(11,'D00000110',NULL,NULL,28,'name','企业名称',1,150,276),(12,'D00000110',NULL,'pop_company',28,'name','企业名称',1,150,276),(13,'D00000110',NULL,NULL,28,'code','社会信用代码',3,150,235),(14,'P00000178',NULL,'org_staff',28,NULL,'岗位信息',8,150,237),(15,'P00000176',NULL,'org_dept',28,'group_full_simple_name','集团信息',1,280,287),(16,'P00000200',NULL,NULL,28,'code','页面编号',2,150,212),(17,'P00000210',NULL,NULL,28,'page_perms','页面权限标识',4,120,169),(18,'P00000150',NULL,NULL,28,NULL,'岗位信息',9,150,213),(19,'P00000210',NULL,NULL,28,'page_code','页面编号',2,120,180),(20,'D00000140',NULL,NULL,28,NULL,'岗位信息',9,150,221),(21,'D00000140',NULL,NULL,28,'u_time','更新时间',12,180,221),(24,'P00000041',NULL,NULL,28,'perms','权限标识',7,80,387),(25,'P00000050',NULL,NULL,28,'label','字典标签',4,120,162),(26,'P00000050',NULL,NULL,28,'dictTypeCode','字典类型',2,130,218),(27,NULL,NULL,NULL,28,'type_name','类型',2,60,202),(28,'P00000220',NULL,NULL,28,'component','页面地址',3,200,379),(29,NULL,NULL,NULL,28,'ORG_COMPANY_EDIT','企业变更',24,25,34),(30,'P00000200',NULL,NULL,28,'component','页面地址',4,200,418),(31,'P00000200',NULL,NULL,28,'perms','权限标识',5,150,241),(32,NULL,NULL,NULL,28,'ADD','新增',4,100,67),(33,NULL,NULL,NULL,28,'UPDATE','修改',5,100,80),(34,NULL,NULL,NULL,28,'COPY_INSERT','复制新增',6,100,68),(35,NULL,NULL,NULL,28,'COPY_INSERT','复制新增',6,100,87),(36,'P00000250',NULL,NULL,28,'oper','权限操作',6,100,175),(37,'P00000250',NULL,NULL,28,NULL,'删除·启用',5,100,131),(38,'P00000250',NULL,NULL,28,'name','权限名称',2,130,140),(39,NULL,NULL,NULL,28,'name','菜单名称',1,120,234),(40,NULL,NULL,NULL,28,'type_name','类型',2,50,170);
/*!40000 ALTER TABLE `s_column_size` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `s_config` (
  ...
  `is_enable` tinyint(1) DEFAULT NULL COMMENT '是否启用(1:true-已启用,0:false-已禁用)',
  `descr` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '说明',
  `corp_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '租户代码',
  `corp_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '租户名称',
  `c_id` bigint DEFAULT NULL,
  `c_time` datetime DEFAULT NULL,
...
INSERT INTO `s_config` VALUES (6,'1','1','1',0,'1',NULL,NULL,25,'2019-09-30 01:16:50',25,'2019-09-30 01:16:50',0),(7,'12','12','12',0,NULL,NULL,NULL,25,'2019-09-30 01:17:02',25,'2019-09-30 01:17:02',0);
...
CREATE TABLE `s_dict_data` (
  ...
  `dict_type_id` bigint DEFAULT NULL COMMENT '字典类型表id主键',
  `sort` tinyint DEFAULT NULL COMMENT '字典排序',
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=148 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='字典类型表、字典主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_function` (
  ...
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '按钮名称',
  `sort` int DEFAULT NULL COMMENT '排序',
  `descr` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '说明',
  `c_id` bigint DEFAULT NULL,
  `c_time` datetime DEFAULT NULL,
  ...
  `dbversion` int DEFAULT NULL COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_s_function_1` (`code`,`name`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='按钮表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_function` VALUES (1,'ADD','新增',0,'',28,'2020-06-16 15:31:02',28,'2020-06-23 17:01:38',56),(2,'UPDATE','修改',1,'',28,'2020-06-16 15:31:11',28,'2020-06-23 17:01:38',56),(3,'COPY_INSERT','复制新增',2,'',28,'2020-06-17 09:49:36',28,'2020-06-23 17:01:38',56),(4,'REAL_DELETE','物理删除',4,'',28,'2020-06-17 09:51:18',28,'2020-06-23 17:01:38',56),(5,'INFO','查看',5,'',28,'2020-06-17 09:52:58',28,'2020-06-23 17:01:38',56),(6,'T_DELETE','删除:表格',9,'表格内的删除',28,'2020-06-17 09:55:25',28,'2020-06-23 17:01:38',58),(7,'SEARCH','查询',6,'',28,'2020-06-17 09:56:59',28,'2020-06-23 17:01:38',56),(11,'EXPORT','导出',7,'',28,'2020-06-17 13:59:12',28,'2020-06-23 17:01:38',43),(12,'D_OK','确定',10,'弹出框中的确定',28,'2020-06-17 14:00:35',28,'2020-06-23 17:01:38',43),(13,'STAFF_POSITION','设置员工岗位',11,'',28,'2020-06-17 14:02:42',28,'2020-06-23 17:01:38',43),(14,'STAFF_ROLE','设置角色',13,'',28,'2020-06-17 14:03:04',28,'2020-06-23 17:01:38',43),(15,'STAFF_PASSWORD','设置密码',12,'',28,'2020-06-17 14:03:37',28,'2020-06-23 17:01:38',43),(16,'T_STAFF_POSITION','跳转至岗位',15,'员工页面中，点击岗位tab，跳转到岗位页面',28,'2020-06-17 14:05:45',28,'2020-06-23 17:01:38',43),(17,'T_ADD_STAFF','添加员工',14,'',28,'2020-06-17 14:07:03',28,'2020-06-23 17:01:38',43),(18,'ORG_ADD_SUB','添加子组织',17,'',28,'2020-06-17 14:07:34',28,'2020-06-23 17:01:38',43),(19,'ORG_CHANGE','更新当前选中的组织',16,'',28,'2020-06-17 14:24:06',28,'2020-06-23 17:01:38',43),(20,'ORG_DEL','删除当前选中的组织和子组织',18,'',28,'2020-06-17 14:24:59',28,'2020-06-23 17:01:38',43),(21,'ORG_GROUP_EDIT','集团变更',19,'',28,'2020-06-17 14:26:49',28,'2020-06-23 17:01:38',43),(22,'ORG_COMPANY_EDIT','企业变更',20,'',28,'2020-06-17 14:27:23',28,'2020-06-23 17:01:38',43),(23,'ORG_DEPT_EDIT','部门变更',21,'',28,'2020-06-17 14:27:47',28,'2020-06-23 17:01:38',43),(24,'ORG_POSITION_EDIT','岗位变更',22,'',28,'2020-06-17 14:28:20',28,'2020-06-23 17:01:38',43),(25,'ORG_POSITION_ADD_STAFF','岗位-添加员工',23,'',28,'2020-06-17 14:30:35',28,'2020-06-23 17:01:38',43),(26,'IMPORT','数据批量导入',8,'',28,'2020-06-17 14:31:44',28,'2020-06-23 17:01:38',39),(27,'DELETE','删除',3,'',28,'2020-06-23 17:00:56',28,'2020-06-23 17:01:38',20);
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `s_job` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '定时任务调度表',
  ...
  `job_serial_id` bigint DEFAULT NULL COMMENT '关联编号',
  ...
  `run_times` int DEFAULT NULL COMMENT '运行次数',
...
CREATE TABLE `s_job_log` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '定时任务调度表',
  `job_id` bigint DEFAULT NULL COMMENT '任务主键',
...
CREATE TABLE `s_log` (
  ...
  `c_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4974 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_log_oper` (
  ...
  `platform` int DEFAULT NULL COMMENT '操作类别（0其它 1后台用户 2手机端用户）',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=441 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_log_oper_detail` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '操作日志记录',
  `oper_id` bigint DEFAULT NULL COMMENT '操作日志主表id',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2352 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志明细表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_log_sys` (
  ...
  `http_method` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'HTTP方法',
  `params` json DEFAULT NULL COMMENT '参数',
  `session` json DEFAULT NULL COMMENT 'session json',
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'url',
  ...
  `c_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=60662 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='系统日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_pages` (
  ...
  `code` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '配置vue export default  name时所使用的type：constants_program.P_VUE_SETTING',
  `name` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '页面名称',
  `component` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '页面地址：@/views/10_system/vuesetting/vue',
  `perms` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '权限标识',
  `meta_title` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '页面的名称',
  `meta_icon` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单中显示的icon',
  `descr` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '说明',
  ...
  `dbversion` int DEFAULT NULL COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_s_pages_1` (`code`,`component`,`perms`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='页面表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_pages` VALUES (1,'P00000180','系统编码','@/views/00_platform/syscode/syscode','P_SYSCODE','系统编码','syscode','11',28,'2020-06-05 14:45:34',28,'2020-06-05 14:57:31',1),(2,'P00000030','字典类型','@/views/10_system/dicttype/dicttype','P_DICT_TYPE','系统编码','type',NULL,28,'2020-06-08 09:45:11',28,'2020-06-08 09:45:11',0),(3,'P00000050','字典数据','@/views/10_system/dictdata/dictdata','P_DICT_DATA','字典数据','dict',NULL,28,'2020-06-08 09:45:33',28,'2020-06-08 09:45:33',0),(4,'P00000060','系统参数','@/views/10_system/config/config','P_CONFIG','系统参数','系统参数',NULL,28,'2020-06-08 09:45:58',28,'2020-06-08 09:45:58',0),(5,'P00000080','租户管理','@/views/10_system/tenant/tenant','P_TENANT','租户管理','tenant',NULL,28,'2020-06-08 09:46:22',28,'2020-06-08 09:46:22',0),(6,'P00000100','集团信息','@/views/20_master/group/group','P_GROUP','集团信息','group',NULL,28,'2020-06-08 09:46:43',28,'2020-06-08 09:46:43',0),(7,'P00000110','企业信息','@/views/20_master/company/company','P_COMPANY','企业信息','company',NULL,28,'2020-06-08 09:47:06',28,'2020-06-08 09:47:06',0),(8,'P00000130','地址簿','@/views/20_master/address/address','P_ADDRESS','地址簿','address',NULL,28,'2020-06-08 09:47:27',28,'2020-06-08 09:47:27',0),(9,'P00000140','员工管理','@/views/20_master/staff/staff','P_STAFF','员工管理','staff',NULL,28,'2020-06-08 09:47:45',28,'2020-06-08 09:47:45',0),(10,'P00000150','部门信息','@/views/20_master/dept/dept','P_DEPT','部门信息','dept',NULL,28,'2020-06-08 09:48:21',28,'2020-06-08 09:48:21',0),(11,'P00000160','岗位信息','@/views/20_master/position/position','P_POSITION','岗位信息','position',NULL,28,'2020-06-08 09:48:38',28,'2020-06-08 09:48:38',0),(12,'P00000170','组织机构管理','@/views/20_master/org/org','P_ORG','组织机构管理','组织机构管理',NULL,28,'2020-06-08 09:48:52',28,'2020-06-08 09:48:52',0),(15,'P00000070','首页','@/views/01_dashboard/index','P_DASHBOARD','首页','dashboard',NULL,28,'2020-07-08 16:07:27',28,'2020-07-08 16:07:27',0),(16,'P00000230','系统icon','@/views/10_system/icons/icon','P_ICONS','系统icon','icons',NULL,28,'2020-07-10 09:29:41',28,'2020-07-10 09:29:41',0),(17,'P00000020','资源管理','@/views/10_system/resource/resource','P_RESOURCE','资源管理','资源管理',NULL,28,'2020-07-20 15:37:25',28,'2020-07-20 15:37:25',0),(18,'P00000220','按钮维护','@/views/10_system/pages/function/function','P_SYS_FUNCTIONS','按钮维护','buttons',NULL,28,'2020-07-20 16:43:39',28,'2020-07-20 16:45:22',1),(19,'P00000200','页面维护','@/views/10_system/pages/page/page','P_SYS_FUNCTIONS','页面维护','pages',NULL,28,'2020-07-20 16:44:56',28,'2020-07-20 16:44:56',0),(20,'P00000210','页面按钮维护','@/views/10_system/pages/page_function/page_function','P_SYS_PAGE_FUNCTIONS','页面按钮维护','page_fun',NULL,28,'2020-07-20 16:48:15',28,'2020-07-20 16:48:15',0),(21,'P00000240','菜单维护','@/views/20_master/menus/menu','P_MENUS','菜单维护','menus',NULL,28,'2020-07-20 16:51:22',28,'2020-07-20 16:51:22',0);
/*!40000 ALTER TABLE `s_pages` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `s_pages_function`
--

DROP TABLE IF EXISTS `s_pages_function`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `s_pages_function` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `page_id` bigint DEFAULT NULL COMMENT '页面id',
  `type` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型：PAGE：主页面上，TABLE：表格上，POPUP：弹出框上',
  `function_id` bigint DEFAULT NULL COMMENT '按钮id',
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`),
  KEY `idx_s_pages_function_1` (`id`,`page_id`,`type`,`function_id`,`sort`) /*!80000 INVISIBLE */
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='页面按钮表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `s_pages_function`
--

LOCK TABLES `s_pages_function` WRITE;
/*!40000 ALTER TABLE `s_pages_function` DISABLE KEYS */;
INSERT INTO `s_pages_function` VALUES (4,6,NULL,1,1,'P_GROUP:ADD',NULL,28,'2020-06-19 17:13:49',28,'2020-06-22 16:42:04',4),(9,6,NULL,2,2,'P_GROUP:UPDATE',NULL,28,'2020-06-22 17:04:30',28,'2020-06-22 17:04:30',0),(10,6,'',3,3,'P_GROUP:COPY_INSERT',NULL,28,'2020-06-22 17:05:38',28,'2020-06-22 17:05:38',0),(13,6,'',11,4,'P_GROUP:EXPORT',NULL,28,'2020-06-23 16:47:55',28,'2020-06-23 16:47:55',0),(14,6,'',5,5,'P_GROUP:INFO','',28,'2020-06-23 16:48:07',28,'2020-06-23 16:48:07',0),(15,6,'',6,6,'P_GROUP:T_DELETE','',28,'2020-06-23 16:48:48',28,'2020-06-23 16:48:48',0),(16,6,'',12,7,'P_GROUP:D_OK','弹出框中的确定',28,'2020-06-23 16:51:39',28,'2020-06-23 16:51:39',0),(17,7,NULL,1,1,'P_COMPANY:ADD',NULL,28,'2020-06-23 16:53:37',28,'2020-06-23 16:53:37',0),(18,7,NULL,2,2,'P_COMPANY:UPDATE',NULL,28,'2020-06-23 16:55:21',28,'2020-06-23 16:55:21',0),(19,7,'',3,3,'P_COMPANY:COPY_INSERT','',28,'2020-06-23 16:55:29',28,'2020-06-23 16:55:29',0),(20,7,'',11,4,'P_COMPANY:EXPORT','',28,'2020-06-23 16:55:38',28,'2020-06-23 16:55:38',0),(21,7,'',5,5,'P_COMPANY:INFO','',28,'2020-06-23 16:55:48',28,'2020-06-23 16:55:48',0),(22,7,'',6,6,'P_COMPANY:T_DELETE','表格内删除',28,'2020-06-23 16:56:06',28,'2020-06-23 16:56:06',0),(23,7,'',12,7,'P_COMPANY:D_OK','弹出框中的确定',28,'2020-06-23 16:56:53',28,'2020-06-23 16:56:53',0),(24,8,NULL,1,1,'P_ADDRESS:ADD',NULL,28,'2020-06-23 16:57:14',28,'2020-06-23 16:57:14',0),(25,8,NULL,2,2,'P_ADDRESS:UPDATE',NULL,28,'2020-06-23 16:57:26',28,'2020-06-23 16:57:26',0),(26,8,'',3,3,'P_ADDRESS:COPY_INSERT','',28,'2020-06-23 16:57:33',28,'2020-06-30 17:18:47',2),(27,8,'',27,4,'P_ADDRESS:DELETE','',28,'2020-06-23 17:01:46',28,'2020-06-23 17:01:46',0),(28,8,'',5,5,'P_ADDRESS:INFO','',28,'2020-06-23 17:02:00',28,'2020-06-23 17:02:00',0),(29,8,'',12,6,'P_ADDRESS:D_OK','',28,'2020-06-23 17:02:30',28,'2020-06-23 17:02:30',0),(30,9,NULL,1,1,'P_STAFF:ADD',NULL,28,'2020-06-23 17:02:55',28,'2020-06-23 17:02:55',0),(31,9,'',2,2,'P_STAFF:UPDATE','',28,'2020-06-23 17:03:02',28,'2020-06-23 17:03:02',0),(32,9,'',11,3,'P_STAFF:EXPORT','',28,'2020-06-23 17:03:12',28,'2020-06-23 17:03:12',0),(33,9,'',5,4,'P_STAFF:INFO','',28,'2020-06-24 15:17:45',28,'2020-06-30 17:19:44',15);
/*!40000 ALTER TABLE `s_pages_function` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `s_tenant` (
  ...
  `level` tinyint DEFAULT NULL COMMENT '级次',
...
--
-- Temporary view structure for view `v_org_name`
--

DROP TABLE IF EXISTS `v_org_name`;
/*!50001 DROP VIEW IF EXISTS `v_org_name`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_org_name` AS SELECT 
 1 AS `serial_id`,
 1 AS `name`,
 1 AS `simple_name`,
 1 AS `is_del`,
...
--
-- Temporary view structure for view `v_org_route_company_dept_info`
--

DROP TABLE IF EXISTS `v_org_route_company_dept_info`;
/*!50001 DROP VIEW IF EXISTS `v_org_route_company_dept_info`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_org_route_company_dept_info` AS SELECT 
 1 AS `id`,
 1 AS `org_id`,
 1 AS `org_parent_id`,
 1 AS `current_id`,
 1 AS `parent_id`,
 1 AS `parent_type`,
 1 AS `root_company_id`,
 1 AS `parent_dept_name`,
 1 AS `parent_dept_simple_name`,
 1 AS `counts`,
 1 AS `sort`,
 1 AS `tenant_name`,
 1 AS `tenant_simple_name`,
 1 AS `parent_group_name`,
 1 AS `parent_group_simple_name`,
 1 AS `group_full_name`,
 1 AS `group_full_simple_name`,
 1 AS `company_name`,
 1 AS `company_simple_name`,
 1 AS `dept_full_name`,
 1 AS `dept_full_simple_name`,
 1 AS `type`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `v_org_route_dept_position_info`
--

DROP TABLE IF EXISTS `v_org_route_dept_position_info`;
/*!50001 DROP VIEW IF EXISTS `v_org_route_dept_position_info`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_org_route_dept_position_info` AS SELECT 
 1 AS `id`,
 1 AS `org_id`,
 1 AS `org_parent_id`,
 1 AS `current_id`,
...
--
-- Temporary view structure for view `v_org_route_group_company_info`
--

DROP TABLE IF EXISTS `v_org_route_group_company_info`;
/*!50001 DROP VIEW IF EXISTS `v_org_route_group_company_info`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_org_route_group_company_info` AS SELECT 
 1 AS `id`,
 1 AS `org_id`,
 1 AS `org_parent_id`,
 1 AS `current_id`,
 1 AS `parent_id`,
 1 AS `parent_type`,
 1 AS `parent_company_name`,
 1 AS `parent_company_simple_name`,
 1 AS `counts`,
 1 AS `sort`,
 1 AS `tenant_name`,
 1 AS `tenant_simple_name`,
...
--
-- Temporary view structure for view `v_org_route_json`
--

DROP TABLE IF EXISTS `v_org_route_json`;
/*!50001 DROP VIEW IF EXISTS `v_org_route_json`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_org_route_json` AS SELECT 
 1 AS `id`,
 1 AS `parent_id`,
 1 AS `tenant_id`,
 1 AS `serial_id`,
...
--
-- Temporary view structure for view `v_org_route_parent_info`
--

DROP TABLE IF EXISTS `v_org_route_parent_info`;
/*!50001 DROP VIEW IF EXISTS `v_org_route_parent_info`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_org_route_parent_info` AS SELECT 
 1 AS `id`,
 1 AS `org_id`,
 1 AS `org_parent_id`,
 1 AS `current_id`,
...
--
-- Temporary view structure for view `v_org_route_tenant_group_info`
--

DROP TABLE IF EXISTS `v_org_route_tenant_group_info`;
/*!50001 DROP VIEW IF EXISTS `v_org_route_tenant_group_info`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_org_route_tenant_group_info` AS SELECT 
 1 AS `id`,
 1 AS `org_id`,
 1 AS `org_parent_id`,
 1 AS `current_id`,
...
--
-- Temporary view structure for view `v_org_tree`
--

DROP TABLE IF EXISTS `v_org_tree`;
/*!50001 DROP VIEW IF EXISTS `v_org_tree`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_org_tree` AS SELECT 
 1 AS `id`,
 1 AS `VALUE`,
 1 AS `tenant_id`,
 1 AS `parent_id`,
...
--
-- Temporary view structure for view `v_permission_operation_info`
--

DROP TABLE IF EXISTS `v_permission_operation_info`;
/*!50001 DROP VIEW IF EXISTS `v_permission_operation_info`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_permission_operation_info` AS SELECT 
 1 AS `tenant_id`,
 1 AS `page_id`,
 1 AS `function_count`,
 1 AS `function_enable_count`,
 1 AS `function_info`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `v_permission_tree`
--

DROP TABLE IF EXISTS `v_permission_tree`;
/*!50001 DROP VIEW IF EXISTS `v_permission_tree`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_permission_tree` AS SELECT 
 1 AS `menu_id`,
 1 AS `tenant_id`,
 1 AS `parent_id`,
 1 AS `LEVEL`,
...
--
/*!50003 DROP FUNCTION IF EXISTS `f_org_route_json` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `f_org_route_json`(`org_json` varchar(500)) RETURNS text CHARSET utf8mb4 COLLATE utf8mb4_general_ci
BEGIN
	DECLARE rtn_context text DEFAULT null;
	
	## 下面是SQL
	 select JSON_ARRAYAGG( JSON_OBJECT('org_id',t1.id,'parent_id',t1.parent_id,'tenant_id',t1.tenant_id,'serial_type',t1.serial_type,'serial_id',t1.serial_id,'code',t1.code,'name',t3.name,'simple_name',t3.simple_name,'is_del',t3.is_del)) as org_context 
	 ## 设置到变量
	 into rtn_context
   from m_org t1 
	INNER JOIN (
						 ...
						 FROM
							 JSON_TABLE(
								 ...
								 COLUMNS(
									 ...
									 org_id BIGINT PATH "$.id"
								 )
							 ) AS subtab
						) t2 on t1.id = t2.org_id
	 LEFT JOIN v_org_name t3 on t3.serial_type = t1.serial_type and t3.serial_id = t1.serial_id
  order by rowid ;
...
--
-- Final view structure for view `v_org_name`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_org_name` AS select `subt1`.`id` AS `serial_id`,`subt1`.`name` AS `name`,`subt1`.`simple_name` AS `simple_name`,`subt1`.`is_del` AS `is_del`,`subt1`.`id` AS `tenant_id`,'10' AS `type`,'s_tenant' AS `serial_type` from `s_tenant` `subt1` union all select `subt2`.`id` AS `serial_id`,`subt2`.`name` AS `name`,`subt2`.`simple_name` AS `simple_name`,`subt2`.`is_del` AS `is_del`,`subt2`.`tenant_id` AS `tenant_id`,'20' AS `type`,'m_group' AS `serial_type` from `m_group` `subt2` union all select `subt3`.`id` AS `serial_id`,`subt3`.`name` AS `name`,`subt3`.`simple_name` AS `simple_name`,`subt3`.`is_del` AS `is_del`,`subt3`.`tenant_id` AS `tenant_id`,'30' AS `type`,'m_company' AS `serial_type` from `m_company` `subt3` union all select `subt4`.`id` AS `serial_id`,`subt4`.`name` AS `name`,`subt4`.`simple_name` AS `simple_name`,`subt4`.`is_del` AS `is_del`,`subt4`.`tenant_id` AS `tenant_id`,'40' AS `type`,'m_dept' AS `serial_type` from `m_dept` `subt4` union all select `subt5`.`id` AS `serial_id`,`subt5`.`name` AS `name`,`subt5`.`simple_name` AS `simple_name`,`subt5`.`is_del` AS `is_del`,`subt5`.`tenant_id` AS `tenant_id`,'50' AS `type`,'m_position' AS `serial_type` from `m_position` `subt5` union all select `subt6`.`id` AS `serial_id`,`subt6`.`name` AS `name`,`subt6`.`simple_name` AS `simple_name`,`subt6`.`is_del` AS `is_del`,`subt6`.`tenant_id` AS `tenant_id`,'60' AS `type`,'m_staff' AS `serial_type` from `m_staff` `subt6` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `v_org_route_company_dept_info`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_org_route_company_dept_info` AS with recursive `company_dept_cte` as (select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,`t1`.`root_company_id` AS `root_company_id`,(cast(`t2`.`name` as char(1000) charset utf8mb4) collate utf8mb4_general_ci) AS `parent_name`,(cast(`t2`.`simple_name` as char(1000) charset utf8mb4) collate utf8mb4_general_ci) AS `parent_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from (`m_org_company_dept` `t1` left join `m_dept` `t2` on(((`t1`.`parent_id` = `t2`.`id`) and (`t1`.`parent_type` = 'm_dept')))) where (`t1`.`sort` = 1) union all select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,`t1`.`root_company_id` AS `root_company_id`,concat(ifnull(`company_dept_cte`.`parent_name`,''),(case when (`company_dept_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`name`) AS `parent_name`,concat(ifnull(`company_dept_cte`.`parent_simple_name`,''),(case when (`company_dept_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`simple_name`) AS `simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from ((select `sub1`.`id` AS `id`,`sub1`.`org_id` AS `org_id`,`sub1`.`org_parent_id` AS `org_parent_id`,`sub1`.`current_id` AS `current_id`,`sub1`.`root_company_id` AS `root_company_id`,`sub1`.`parent_id` AS `parent_id`,`sub1`.`parent_type` AS `parent_type`,`sub2`.`name` AS `name`,`sub2`.`simple_name` AS `simple_name`,`sub1`.`counts` AS `counts`,`sub1`.`sort` AS `sort` from (`m_org_company_dept` `sub1` left join `m_dept` `sub2` on((`sub1`.`parent_id` = `sub2`.`id`)))) `t1` join `company_dept_cte` on((`t1`.`org_parent_id` = `company_dept_cte`.`org_id`)))) select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,`t1`.`root_company_id` AS `root_company_id`,`t1`.`parent_name` AS `parent_dept_name`,`t1`.`parent_simple_name` AS `parent_dept_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort`,`t2`.`tenant_name` AS `tenant_name`,`t2`.`tenant_simple_name` AS `tenant_simple_name`,`t2`.`parent_group_name` AS `parent_group_name`,`t2`.`parent_group_simple_name` AS `parent_group_simple_name`,`t2`.`group_full_name` AS `group_full_name`,`t2`.`group_full_simple_name` AS `group_full_simple_name`,`t4`.`name` AS `company_name`,`t4`.`simple_name` AS `company_simple_name`,(case when (`t1`.`parent_name` is null) then `t3`.`name` else concat(`t1`.`parent_name`,' > ',`t3`.`name`) end) AS `dept_full_name`,(case when (`t1`.`parent_name` is null) then `t3`.`simple_name` else concat(`t1`.`parent_simple_name`,' > ',`t3`.`simple_name`) end) AS `dept_full_simple_name`,'m_dept' AS `type` from (((`company_dept_cte` `t1` left join `v_org_route_group_company_info` `t2` on((`t1`.`root_company_id` = `t2`.`current_id`))) left join `m_dept` `t3` on((`t1`.`current_id` = `t3`.`id`))) left join `m_company` `t4` on((`t1`.`root_company_id` = `t4`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_org_route_dept_position_info`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_org_route_dept_position_info` AS with recursive `dept_position_cte` as (select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,`t1`.`root_id` AS `root_id`,(cast(`t2`.`name` as char(1000) charset utf8mb4) collate utf8mb4_general_ci) AS `parent_name`,(cast(`t2`.`simple_name` as char(1000) charset utf8mb4) collate utf8mb4_general_ci) AS `parent_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from (`m_org_dept_position` `t1` left join `m_position` `t2` on((`t1`.`parent_id` = `t2`.`id`))) where (`t1`.`sort` = 1) union all select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,`t1`.`root_id` AS `root_id`,concat(ifnull(`dept_position_cte`.`parent_name`,''),(case when (`dept_position_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`name`) AS `parent_name`,concat(ifnull(`dept_position_cte`.`parent_simple_name`,''),(case when (`dept_position_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`simple_name`) AS `simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from ((select `sub1`.`id` AS `id`,`sub1`.`org_id` AS `org_id`,`sub1`.`org_parent_id` AS `org_parent_id`,`sub1`.`current_id` AS `current_id`,`sub1`.`parent_id` AS `parent_id`,`sub1`.`root_id` AS `root_id`,`sub1`.`parent_type` AS `parent_type`,`sub2`.`name` AS `name`,`sub2`.`simple_name` AS `simple_name`,`sub1`.`counts` AS `counts`,`sub1`.`sort` AS `sort` from (`m_org_dept_position` `sub1` left join `m_position` `sub2` on((`sub1`.`parent_id` = `sub2`.`id`)))) `t1` join `dept_position_cte` on((`t1`.`org_parent_id` = `dept_position_cte`.`org_id`)))) select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,`t1`.`root_id` AS `root_id`,`t1`.`parent_name` AS `parent_name`,`t1`.`parent_simple_name` AS `parent_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort`,`t2`.`group_full_name` AS `group_full_name`,`t2`.`group_full_simple_name` AS `group_full_simple_name`,`t2`.`company_name` AS `company_name`,`t2`.`company_simple_name` AS `company_simple_name`,`t2`.`dept_full_name` AS `dept_full_name`,`t2`.`dept_full_simple_name` AS `dept_full_simple_name`,'m_position' AS `type` from (`dept_position_cte` `t1` left join `v_org_route_company_dept_info` `t2` on((`t1`.`parent_id` = `t2`.`current_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_org_route_group_company_info`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_org_route_group_company_info` AS with recursive `group_company_cte` as (select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,(cast(`t2`.`name` as char(1000) charset utf8mb4) collate utf8mb4_general_ci) AS `parent_name`,(cast(`t2`.`simple_name` as char(1000) charset utf8mb4) collate utf8mb4_general_ci) AS `parent_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from (`m_org_group_company` `t1` left join `m_company` `t2` on((`t1`.`parent_id` = `t2`.`id`))) where (`t1`.`sort` = 1) union all select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,concat(ifnull(`group_company_cte`.`parent_name`,''),(case when (`group_company_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`name`) AS `parent_name`,concat(ifnull(`group_company_cte`.`parent_simple_name`,''),(case when (`group_company_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`simple_name`) AS `simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from ((select `sub1`.`id` AS `id`,`sub1`.`org_id` AS `org_id`,`sub1`.`org_parent_id` AS `org_parent_id`,`sub1`.`current_id` AS `current_id`,`sub1`.`parent_id` AS `parent_id`,`sub1`.`parent_type` AS `parent_type`,`sub2`.`name` AS `name`,`sub2`.`simple_name` AS `simple_name`,`sub1`.`counts` AS `counts`,`sub1`.`sort` AS `sort` from (`m_org_group_company` `sub1` left join `m_company` `sub2` on((`sub1`.`parent_id` = `sub2`.`id`)))) `t1` join `group_company_cte` on((`t1`.`org_parent_id` = `group_company_cte`.`org_id`)))) select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,`t1`.`parent_name` AS `parent_company_name`,`t1`.`parent_simple_name` AS `parent_company_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort`,`t2`.`tenant_name` AS `tenant_name`,`t2`.`tenant_simple_name` AS `tenant_simple_name`,`t2`.`parent_group_name` AS `parent_group_name`,`t2`.`parent_group_simple_name` AS `parent_group_simple_name`,`t2`.`group_full_name` AS `group_full_name`,`t2`.`group_full_simple_name` AS `group_full_simple_name`,'m_company' AS `type` from (`group_company_cte` `t1` left join `v_org_route_tenant_group_info` `t2` on((`t1`.`parent_id` = `t2`.`current_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_org_route_json`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_org_route_json` AS with recursive `cte` as (select `t1`.`id` AS `id`,`t1`.`parent_id` AS `parent_id`,`t1`.`tenant_id` AS `tenant_id`,`t1`.`serial_id` AS `serial_id`,`t1`.`serial_type` AS `serial_type`,cast('{"id": null}' as char(255) charset utf8mb4) AS `id_route` from `m_org` `t1` where (`t1`.`parent_id` is null) union all select `t1`.`id` AS `id`,`t1`.`parent_id` AS `parent_id`,`t1`.`tenant_id` AS `tenant_id`,`t1`.`serial_id` AS `serial_id`,`t1`.`serial_type` AS `serial_type`,concat(`cte`.`id_route`,',',concat('{"id":',`cte`.`id`,'}')) AS `id_route` from (`m_org` `t1` join `cte` on((`t1`.`parent_id` = `cte`.`id`)))) select `cte`.`id` AS `id`,`cte`.`parent_id` AS `parent_id`,`cte`.`tenant_id` AS `tenant_id`,`cte`.`serial_id` AS `serial_id`,`cte`.`serial_type` AS `serial_type`,`cte`.`id_route` AS `id_route`,`f_org_route_json`(concat('[',`cte`.`id_route`,']')) AS `org_route` from `cte` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_org_route_parent_info`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_org_route_parent_info` AS with recursive `tenant_group_cte` as (select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,cast(`t2`.`name` as char(1000) charset utf8mb4) AS `parent_name`,cast(`t2`.`simple_name` as char(1000) charset utf8mb4) AS `parent_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from (`m_org_tenant_group` `t1` left join `m_group` `t2` on((`t1`.`parent_id` = `t2`.`id`))) where (`t1`.`sort` = 1) union all select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,concat(ifnull(`tenant_group_cte`.`parent_name`,''),(case when (`tenant_group_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`name`) AS `parent_name`,concat(ifnull(`tenant_group_cte`.`parent_simple_name`,''),(case when (`tenant_group_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`simple_name`) AS `simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from ((select `sub1`.`id` AS `id`,`sub1`.`org_id` AS `org_id`,`sub1`.`org_parent_id` AS `org_parent_id`,`sub1`.`current_id` AS `current_id`,`sub1`.`parent_id` AS `parent_id`,`sub1`.`parent_type` AS `parent_type`,`sub2`.`name` AS `name`,`sub2`.`simple_name` AS `simple_name`,`sub1`.`counts` AS `counts`,`sub1`.`sort` AS `sort` from (`m_org_tenant_group` `sub1` left join `m_group` `sub2` on((`sub1`.`parent_id` = `sub2`.`id`)))) `t1` join `tenant_group_cte` on((`t1`.`org_parent_id` = `tenant_group_cte`.`org_id`)))), `group_company_cte` as (select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,cast(`t2`.`name` as char(1000) charset utf8mb4) AS `parent_name`,cast(`t2`.`simple_name` as char(1000) charset utf8mb4) AS `parent_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from (`m_org_group_company` `t1` left join `m_company` `t2` on((`t1`.`parent_id` = `t2`.`id`))) where (`t1`.`sort` = 1) union all select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,concat(ifnull(`group_company_cte`.`parent_name`,''),(case when (`group_company_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`name`) AS `parent_name`,concat(ifnull(`group_company_cte`.`parent_simple_name`,''),(case when (`group_company_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`simple_name`) AS `simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from ((select `sub1`.`id` AS `id`,`sub1`.`org_id` AS `org_id`,`sub1`.`org_parent_id` AS `org_parent_id`,`sub1`.`current_id` AS `current_id`,`sub1`.`parent_id` AS `parent_id`,`sub1`.`parent_type` AS `parent_type`,`sub2`.`name` AS `name`,`sub2`.`simple_name` AS `simple_name`,`sub1`.`counts` AS `counts`,`sub1`.`sort` AS `sort` from (`m_org_group_company` `sub1` left join `m_company` `sub2` on((`sub1`.`parent_id` = `sub2`.`id`)))) `t1` join `group_company_cte` on((`t1`.`org_parent_id` = `group_company_cte`.`org_id`)))), `company_dept_cte` as (select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,cast(`t2`.`name` as char(1000) charset utf8mb4) AS `parent_name`,cast(`t2`.`simple_name` as char(1000) charset utf8mb4) AS `parent_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from (`m_org_company_dept` `t1` left join `m_dept` `t2` on((`t1`.`parent_id` = `t2`.`id`))) where (`t1`.`sort` = 1) union all select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,concat(ifnull(`company_dept_cte`.`parent_name`,''),(case when (`company_dept_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`name`) AS `parent_name`,concat(ifnull(`company_dept_cte`.`parent_simple_name`,''),(case when (`company_dept_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`simple_name`) AS `simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from ((select `sub1`.`id` AS `id`,`sub1`.`org_id` AS `org_id`,`sub1`.`org_parent_id` AS `org_parent_id`,`sub1`.`current_id` AS `current_id`,`sub1`.`parent_id` AS `parent_id`,`sub1`.`parent_type` AS `parent_type`,`sub2`.`name` AS `name`,`sub2`.`simple_name` AS `simple_name`,`sub1`.`counts` AS `counts`,`sub1`.`sort` AS `sort` from (`m_org_company_dept` `sub1` left join `m_dept` `sub2` on((`sub1`.`parent_id` = `sub2`.`id`)))) `t1` join `company_dept_cte` on((`t1`.`org_parent_id` = `company_dept_cte`.`org_id`)))), `dept_position_cte` as (select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,cast(`t2`.`name` as char(1000) charset utf8mb4) AS `parent_name`,cast(`t2`.`simple_name` as char(1000) charset utf8mb4) AS `parent_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from (`m_org_dept_position` `t1` left join `m_position` `t2` on((`t1`.`parent_id` = `t2`.`id`))) where (`t1`.`sort` = 1) union all select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,concat(ifnull(`dept_position_cte`.`parent_name`,''),(case when (`dept_position_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`name`) AS `parent_name`,concat(ifnull(`dept_position_cte`.`parent_simple_name`,''),(case when (`dept_position_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`simple_name`) AS `simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from ((select `sub1`.`id` AS `id`,`sub1`.`org_id` AS `org_id`,`sub1`.`org_parent_id` AS `org_parent_id`,`sub1`.`current_id` AS `current_id`,`sub1`.`parent_id` AS `parent_id`,`sub1`.`parent_type` AS `parent_type`,`sub2`.`name` AS `name`,`sub2`.`simple_name` AS `simple_name`,`sub1`.`counts` AS `counts`,`sub1`.`sort` AS `sort` from (`m_org_dept_position` `sub1` left join `m_position` `sub2` on((`sub1`.`parent_id` = `sub2`.`id`)))) `t1` join `dept_position_cte` on((`t1`.`org_parent_id` = `dept_position_cte`.`org_id`)))) select `tenant_group_cte`.`id` AS `id`,`tenant_group_cte`.`org_id` AS `org_id`,`tenant_group_cte`.`org_parent_id` AS `org_parent_id`,`tenant_group_cte`.`current_id` AS `current_id`,`tenant_group_cte`.`parent_id` AS `parent_id`,`tenant_group_cte`.`parent_type` AS `parent_type`,`tenant_group_cte`.`parent_name` AS `parent_name`,`tenant_group_cte`.`parent_simple_name` AS `parent_simple_name`,`tenant_group_cte`.`counts` AS `counts`,`tenant_group_cte`.`sort` AS `sort`,'m_group' AS `type` from `tenant_group_cte` union all select `group_company_cte`.`id` AS `id`,`group_company_cte`.`org_id` AS `org_id`,`group_company_cte`.`org_parent_id` AS `org_parent_id`,`group_company_cte`.`current_id` AS `current_id`,`group_company_cte`.`parent_id` AS `parent_id`,`group_company_cte`.`parent_type` AS `parent_type`,`group_company_cte`.`parent_name` AS `parent_name`,`group_company_cte`.`parent_simple_name` AS `parent_simple_name`,`group_company_cte`.`counts` AS `counts`,`group_company_cte`.`sort` AS `sort`,'m_company' AS `type` from `group_company_cte` union all select `company_dept_cte`.`id` AS `id`,`company_dept_cte`.`org_id` AS `org_id`,`company_dept_cte`.`org_parent_id` AS `org_parent_id`,`company_dept_cte`.`current_id` AS `current_id`,`company_dept_cte`.`parent_id` AS `parent_id`,`company_dept_cte`.`parent_type` AS `parent_type`,`company_dept_cte`.`parent_name` AS `parent_name`,`company_dept_cte`.`parent_simple_name` AS `parent_simple_name`,`company_dept_cte`.`counts` AS `counts`,`company_dept_cte`.`sort` AS `sort`,'m_dept' AS `type` from `company_dept_cte` union all select `dept_position_cte`.`id` AS `id`,`dept_position_cte`.`org_id` AS `org_id`,`dept_position_cte`.`org_parent_id` AS `org_parent_id`,`dept_position_cte`.`current_id` AS `current_id`,`dept_position_cte`.`parent_id` AS `parent_id`,`dept_position_cte`.`parent_type` AS `parent_type`,`dept_position_cte`.`parent_name` AS `parent_name`,`dept_position_cte`.`parent_simple_name` AS `parent_simple_name`,`dept_position_cte`.`counts` AS `counts`,`dept_position_cte`.`sort` AS `sort`,'m_position' AS `type` from `dept_position_cte` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_org_route_tenant_group_info`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_org_route_tenant_group_info` AS with recursive `tenant_group_cte` as (select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,(cast(`t2`.`name` as char(1000) charset utf8mb4) collate utf8mb4_general_ci) AS `parent_name`,(cast(`t2`.`simple_name` as char(1000) charset utf8mb4) collate utf8mb4_general_ci) AS `parent_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from (`m_org_tenant_group` `t1` left join `m_group` `t2` on((`t1`.`parent_id` = `t2`.`id`))) where (`t1`.`sort` = 1) union all select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,concat(ifnull(`tenant_group_cte`.`parent_name`,''),(case when (`tenant_group_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`name`) AS `parent_name`,concat(ifnull(`tenant_group_cte`.`parent_simple_name`,''),(case when (`tenant_group_cte`.`parent_name` is null) then '' else ' > ' end),`t1`.`simple_name`) AS `simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort` from ((select `sub1`.`id` AS `id`,`sub1`.`org_id` AS `org_id`,`sub1`.`org_parent_id` AS `org_parent_id`,`sub1`.`current_id` AS `current_id`,`sub1`.`parent_id` AS `parent_id`,`sub1`.`parent_type` AS `parent_type`,`sub2`.`name` AS `name`,`sub2`.`simple_name` AS `simple_name`,`sub1`.`counts` AS `counts`,`sub1`.`sort` AS `sort` from (`m_org_tenant_group` `sub1` left join `m_group` `sub2` on((`sub1`.`parent_id` = `sub2`.`id`)))) `t1` join `tenant_group_cte` on((`t1`.`org_parent_id` = `tenant_group_cte`.`org_id`)))) select `t1`.`id` AS `id`,`t1`.`org_id` AS `org_id`,`t1`.`org_parent_id` AS `org_parent_id`,`t1`.`current_id` AS `current_id`,`t1`.`parent_id` AS `parent_id`,`t1`.`parent_type` AS `parent_type`,`t1`.`parent_name` AS `parent_group_name`,`t1`.`parent_simple_name` AS `parent_group_simple_name`,`t1`.`counts` AS `counts`,`t1`.`sort` AS `sort`,`t2`.`name` AS `tenant_name`,`t2`.`simple_name` AS `tenant_simple_name`,(case when (`t1`.`parent_name` is null) then `t3`.`name` else concat(`t1`.`parent_name`,' > ',`t3`.`name`) end) AS `group_full_name`,(case when (`t1`.`parent_name` is null) then `t3`.`simple_name` else concat(`t1`.`parent_simple_name`,' > ',`t3`.`simple_name`) end) AS `group_full_simple_name`,'m_group' AS `type` from ((`tenant_group_cte` `t1` left join `s_tenant` `t2` on(((`t1`.`parent_type` = 's_tenant') and (`t1`.`parent_id` = `t2`.`id`)))) left join `m_group` `t3` on((`t1`.`current_id` = `t3`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_org_tree`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_org_tree` AS with recursive `cte` as (select `t0`.`id` AS `id`,`t0`.`id` AS `VALUE`,`t0`.`tenant_id` AS `tenant_id`,`t0`.`parent_id` AS `parent_id`,1 AS `LEVEL`,cast(`t0`.`id` as char(50) charset utf8mb4) AS `depth_id` from `m_org` `t0` where (`t0`.`parent_id` is null) union all select `t2`.`id` AS `id`,`t2`.`id` AS `VALUE`,`t2`.`tenant_id` AS `tenant_id`,`t2`.`parent_id` AS `parent_id`,(`t1`.`LEVEL` + 1) AS `LEVEL`,concat(cast(`t1`.`depth_id` as char(50) charset utf8mb4),',',cast(`t2`.`id` as char(50) charset utf8mb4)) AS `depth_id` from (`m_org` `t2` join `cte` `t1`) where (`t2`.`parent_id` = `t1`.`id`)) select `cte`.`id` AS `id`,`cte`.`VALUE` AS `VALUE`,`cte`.`tenant_id` AS `tenant_id`,`cte`.`parent_id` AS `parent_id`,`cte`.`LEVEL` AS `LEVEL`,`cte`.`depth_id` AS `depth_id` from `cte` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_permission_operation_info`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_permission_operation_info` AS select `t1`.`tenant_id` AS `tenant_id`,`t1`.`page_id` AS `page_id`,count(1) AS `function_count`,count((case when (`t2`.`is_enable` = 1) then 1 else NULL end)) AS `function_enable_count`,json_arrayagg(json_object('id',`t2`.`id`,'code',`t3`.`code`,'name',`t3`.`name`,'perms',`t2`.`perms`,'is_enable',`t2`.`is_enable`)) AS `function_info` from ((`m_permission_pages` `t1` left join `m_permission_operation` `t2` on((`t1`.`page_id` = `t2`.`page_id`))) left join `s_function` `t3` on((`t3`.`id` = `t2`.`function_id`))) where (`t2`.`operation_id` is not null) group by `t1`.`tenant_id`,`t1`.`page_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_permission_tree`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_permission_tree` AS with recursive `tab1` as (select `t0`.`menu_id` AS `menu_id`,`t0`.`tenant_id` AS `tenant_id`,`t0`.`parent_id` AS `parent_id`,1 AS `LEVEL`,`t0`.`name` AS `NAME`,`t0`.`name` AS `depth_name`,cast(`t0`.`menu_id` as char(50) charset utf8mb4) AS `depth_id` from `m_permission_menu` `t0` where (`t0`.`parent_id` is null) union all select `t2`.`menu_id` AS `menu_id`,`t2`.`tenant_id` AS `tenant_id`,`t2`.`parent_id` AS `parent_id`,(`t1`.`LEVEL` + 1) AS `LEVEL`,`t2`.`name` AS `NAME`,concat(`t1`.`depth_name`,'>',`t2`.`name`) AS `depth_name`,concat(cast(`t1`.`depth_id` as char(50) charset utf8mb4),',',cast(`t2`.`menu_id` as char(50) charset utf8mb4)) AS `depth_id` from (`m_permission_menu` `t2` join `tab1` `t1`) where (`t2`.`parent_id` = `t1`.`menu_id`)) select `tab1`.`menu_id` AS `menu_id`,`tab1`.`tenant_id` AS `tenant_id`,`tab1`.`parent_id` AS `parent_id`,`tab1`.`LEVEL` AS `LEVEL`,`tab1`.`NAME` AS `NAME`,`tab1`.`depth_name` AS `depth_name`,`tab1`.`depth_id` AS `depth_id` from `tab1` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-08-13 17:20:57
