...
CREATE TABLE `m_menu` (
  ...
  `type` varchar(2) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单类型（R：根节点；N：节点；P：页面）',
  ...
  `parent_path` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '父节点请求地址',
  `path` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '请求地址',
  `full_path` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '完整地址',
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜单信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_menu` VALUES (8,'xx','xx',8,NULL,1,0,'R',0,NULL,NULL,NULL,'/','/',NULL,NULL,NULL,NULL,NULL,'',NULL,28,'2020-07-07 16:56:26',28,'2020-07-07 16:59:15',2),(9,'xx0001','xx',8,8,1,0,'N',0,NULL,NULL,'/','xxaxa','/xxaxa','','','','',0,'',NULL,28,'2020-07-07 16:59:15',28,'2020-07-07 17:08:06',3),(10,'xx00010001','xx',8,9,1,0,'N',0,NULL,NULL,'/xxaxa','xx','/xxaxa/xx','','','','',0,'',NULL,28,'2020-07-07 17:08:06',28,'2020-07-07 17:08:11',1),(11,'xx000100010001','zzz',8,10,0,0,'N',0,NULL,NULL,'/xxaxa/xx','zz','/xxaxa/xx/zz','','','','',0,'',NULL,28,'2020-07-07 17:08:11',28,'2020-07-07 17:08:11',0);
...
CREATE TABLE `m_org` (
  ...
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id，根节点',
  `serial_id` bigint DEFAULT NULL COMMENT '关联单号',
  `serial_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关联单号类型',
...
CREATE TABLE `m_org_company_dept` (
  ...
  `parent_type` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所属父节点类型',
...
INSERT INTO `s_code` VALUES (2,'s_tenant','10','ZH20191216NX001',1,'ZH',25,'2019-12-13 15:11:44',25,'2019-12-13 15:33:12',5),(4,'s_menu','10','M20191216KZ007',7,'M',25,'2019-12-16 15:48:54',25,'2019-12-16 15:48:54',6),(5,'m_group','10','GP20200622JX003',3,'GP',25,'2019-12-18 14:03:36',28,'2020-06-22 17:11:20',26),(6,'m_dept','10','DPT20200601XC001',1,'DPT',25,'2019-12-18 14:36:48',28,'2020-06-01 11:14:06',4),(8,'m_position','10','DEPT20200429AM001',1,'DEPT',25,'2019-12-18 14:54:04',28,'2020-04-29 15:36:30',4),(10,'s_vue_page_setting','11','P00000009',9,'P',25,'2020-04-08 16:18:43',25,'2020-04-09 15:28:19',9);
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='表格列宽';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_dict_data` (
  ...
  `dbversion` int DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=141 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_log_oper` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=425 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_log_oper` VALUES (420,'集团主表更新','更新',1,31,'测试用户','2020-06-22 16:28:55'),(421,'集团主表更新','更新',1,31,'测试用户','2020-06-22 16:29:19'),(422,'集团主表新增','新增',1,31,'测试用户','2020-06-22 17:09:20'),(423,'集团主表新增','新增',1,31,'测试用户','2020-06-22 17:09:32'),(424,'集团主表新增','新增',1,31,'测试用户','2020-06-22 17:11:19');
...
CREATE TABLE `s_log_oper_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18388 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志明细表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_log_sys` (
  ...
  `c_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=49727 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='系统日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='页面表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-07-07 17:11:55
